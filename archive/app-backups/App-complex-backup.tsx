      ...
      try {
        ...
        try {
          ...
          try {
            ...
            console.error(
              '❌ AuthProvider fallback also failed:',
              fallbackError
            );
          }
        }
        ...
        try {
          ...
          try {
            ...
            console.error(
              '❌ AppNavigator fallback also failed:',
              fallbackError
            );
          }
        }
        ...
        try {
          ...
          try {
            const ErrorBoundary = (
              await import('./src/components/ErrorBoundary-fallback')
            ).default;
            loadedComponents.ErrorBoundary = ErrorBoundary;
            console.log('✅ ErrorBoundary fallback loaded');
          } catch (fallbackError) {
            console.error(
              '❌ ErrorBoundary fallback also failed:',
              fallbackError
            );
          }
        }
        ...
        try {
          ...
          try {
            const QueryProvider = (
              await import('./src/providers/QueryProvider-fallback')
            ).default;
            loadedComponents.QueryProvider = QueryProvider;
            console.log('✅ QueryProvider fallback loaded');
          } catch (fallbackError) {
            console.error(
              '❌ QueryProvider fallback also failed:',
              fallbackError
            );
          }
        }
