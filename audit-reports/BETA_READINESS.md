...
| #   | Item                                                                | Status                                                                                                                                                                                                                                                                                           | Where                           |
| --- | ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------- |
| 1   | **Storage bucket policies** — 4 public buckets allowed file listing | `[x]` **Complete.** Phase 1 (RLS), Phase 2a (signed-URL writers), Phase 2b (backfill 8 rows + flip `public=false`) all applied 2026-04-15/16. Advisor confirms Job-storage removed from warnings. Remaining 3 warnings (avatars, contractor-portfolio, profile-images) are intentionally public. | Gate 1 → Security hardening     |
