    ...
    const initializeApp = async () => {
      try {
        ...
        try {
          ...
          console.warn('⚠️ AuthProvider failed to load:', e);
        }
        ...
        try {
          ...
          console.warn('⚠️ AppNavigator failed to load:', e);
        }
        ...
        try {
          ...
          console.warn('⚠️ ErrorBoundary failed to load:', e);
        }
        ...
        try {
          ...
          console.warn('⚠️ QueryProvider failed to load:', e);
        }
