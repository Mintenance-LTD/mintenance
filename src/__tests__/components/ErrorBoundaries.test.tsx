...
describe('Error Boundaries', () => {
  ...
  describe('ScreenErrorBoundary', () => {
    it('renders screen-specific error UI', () => {
      ...
      expect(getByText(/Something went wrong with the Test Screen screen/)).toBeTruthy();
    ...
    it('navigates to custom fallback route', () => {
      const { getByText } = render(
        <ScreenErrorBoundary screenName="Test Screen" fallbackRoute="CustomRoute">
          <ThrowError />
        </ScreenErrorBoundary>
      );
  ...
  describe('AsyncErrorBoundary', () => {
    it('renders async operation error UI', () => {
      ...
      expect(getByText(/The data fetch operation encountered an error/)).toBeTruthy();
      expect(getByText('Try Again')).toBeTruthy();
    });
