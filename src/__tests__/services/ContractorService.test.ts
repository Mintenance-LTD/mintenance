...
describe('ContractorService', () => {
  ...
  const mockContractor = {
    ...
    contractor_skills: [
      { id: 'skill-1', skill_name: 'Plumbing', created_at: '2024-01-01T00:00:00Z' },
      { id: 'skill-2', skill_name: 'Electrical', created_at: '2024-01-01T00:00:00Z' }
    ],
    reviews: [
      {
        id: 'review-1',
  ...
  describe('getNearbyContractors', () => {
    it('should return contractors within radius', async () => {
      ...
      const result = await ContractorService.getNearbyContractors(mockHomeownerLocation, 25);
    ...
    it('should make calculateDistance method accessible for testing', () => {
      ...
      const calculateDistance = (ContractorService as any).calculateDistance.bind(ContractorService);
    ...
    it('should handle database error', async () => {
      ...
      await expect(ContractorService.getNearbyContractors(mockHomeownerLocation, 25))
    ...
    it('should use default radius when none provided', async () => {
      ...
      const result = await ContractorService.getNearbyContractors(mockHomeownerLocation);
  ...
  describe('recordContractorMatch', () => {
    ...
    it('should handle match recording error', async () => {
      ...
      await expect(ContractorService.recordContractorMatch(
        'homeowner-1',
        'contractor-1',
        'like'
  ...
  describe('getContractorMatches', () => {
    it('should return contractor matches', async () => {
      ...
      const result = await ContractorService.getContractorMatches('homeowner-1');
  ...
  describe('updateContractorAvailability', () => {
    ...
    it('should handle update error', async () => {
      ...
      await expect(ContractorService.updateContractorAvailability(
        'contractor-1',
        false
  ...
  describe('searchContractors', () => {
    it('should search contractors by skills', async () => {
      ...
      expect(result).toHaveLength(1);
      expect(mockSupabaseChain.in).toHaveBeenCalledWith('id', expect.any(Array));
    });
  ...
  describe('edge cases and error handling', () => {
    ...
    it('should handle invalid location data', async () => {
      ...
      const result = await ContractorService.getNearbyContractors(invalidLocation, 25);
      expect(result).toHaveLength(0);
    });
  });
});