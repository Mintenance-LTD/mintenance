...
#### 1. AI Model Architectures

**Protected Information:**
- Multi-model fusion algorithm (GPT-4 + Roboflow + Internal classifiers)
- Hybrid inference routing logic (when to use cloud vs edge)
- Confidence scoring methodology (Bayesian fusion)
- Conformal prediction for uncertainty quantification

**Why Trade Secret:**
- Difficult to reverse engineer from API responses
- Frequently updated/improved (patent would be obsolete)
- Competitive advantage comes from continuous refinement
...
**Protected Information:**
- 1,872+ labeled images of property damage
- GPT-4 Vision labels as ground truth
- Contractor feedback annotations
- Job outcome data (price vs actual cost)
- Damage type classifications (custom taxonomy)

**Why Trade Secret:**
- Data is more valuable than algorithms (models can be retrained)
- Competitors would need years to accumulate similar dataset
- Quality of labels (GPT-4 + expert verification) is key
...
**Recommendation:** Wait until tagline is finalized and used in marketing
...
- UK trademark filing (2 marks × 2 classes): £820
- Attorney fees (review + filing): £1,200
- Monitoring service (18 months): £600
- Domain portfolio (see below): £2,480
- **Total: £5,100**

**Ongoing (per year):** £1,200 (renewal + monitoring)
...
|-------|-----------|-------|
| **Trade Secrets** | £500,000 | AI algorithms, training data, agent logic |
| **Trademarks** | £50,000 | Brand recognition (early stage) |
| **Copyright** | £100,000 | 100K+ lines of code, designs |
| **Domains** | £5,000 | mintenance.co.uk, .com, .ai |
| **Total** | **£655,000** | ~13% of £5M pre-money valuation |

### Future IP Value (Post-Series A)

| Asset | Valuation | Notes |
|-------|-----------|-------|
| **Trade Secrets** | £2,000,000 | Proven algorithms, 10K+ training data |
| **Patents** | £1,000,000 | 3 granted patents (UK + international) |
| **Trademarks** | £500,000 | Established brand (UK + EU + US) |
| **Copyright** | £300,000 | Platform code + content |
| **Domains** | £10,000 | Portfolio + premium domains |
| **Total** | **£3,810,000** | ~10-15% of £30M+ Series A valuation |
