...
COMMENT ON COLUMN building_assessments.location IS 'GPS point (EPSG:4326) for spatial queries';
COMMENT ON COLUMN building_assessments.room_metadata IS 'Room context: { room, floor, dimensions, orientation }';
COMMENT ON COLUMN building_assessments.latitude IS 'Denormalized latitude for easy export';
COMMENT ON COLUMN building_assessments.longitude IS 'Denormalized longitude for easy export';
;
