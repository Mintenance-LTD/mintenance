...
-- contract signature (when status flips to 'accepted'). Result: no
-- contract could ever be fully accepted, blocking escrow funding /
-- the whole job lifecycle. jobs has location, city, postcode (no
