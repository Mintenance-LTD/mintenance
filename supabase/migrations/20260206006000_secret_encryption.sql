-- Migration: Secret encryption helpers (from root migrations)
-- Date: 2026-02-06
...
GRANT EXECUTE ON FUNCTION public.get_user_integration_secret(UUID,TEXT,TEXT,TEXT) TO authenticated;
