...
--
-- Applied live via Supabase MCP on 2026-04-25 with name
-- `reviews_select_policy_explicit_intent`. This file mirrors the
-- live change so the local migrations folder stays in sync.
