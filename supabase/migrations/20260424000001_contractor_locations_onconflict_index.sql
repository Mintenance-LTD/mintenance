...
--
-- Applied live via Supabase MCP on 2026-04-24 with name
-- `contractor_locations_onconflict_index`. This file mirrors the live
-- change so the local migrations folder stays in sync.
