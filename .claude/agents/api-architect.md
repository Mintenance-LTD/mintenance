---
name: api-architect
description: API architecture expert for RESTful APIs, GraphQL, microservices, and real-time systems. Use for API design, endpoint optimization, authentication patterns, and API versioning.
