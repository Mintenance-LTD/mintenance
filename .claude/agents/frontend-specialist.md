...
description: Senior React/TypeScript developer for building production-quality components. Use for complex frontend implementation, performance optimization, and architecture decisions.
