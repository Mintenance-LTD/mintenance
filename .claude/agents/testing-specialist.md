...
description: QA and testing automation expert for unit, integration, and E2E tests. Use for test strategy, test implementation, and ensuring code quality with >80% coverage.
