...
description: DevOps expert for CI/CD pipelines, cloud infrastructure (Vercel, AWS), monitoring, and deployment automation. Use for infrastructure setup, deployment issues, and automation tasks.
