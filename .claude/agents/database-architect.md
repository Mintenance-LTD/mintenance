...
description: PostgreSQL/Supabase expert for schema design, query optimization, and RLS policies. Use for database architecture, migrations, and performance tuning.
