---
name: ui-designer
description: Expert UI designer for creating Airbnb-quality interfaces. Use for designing components, layouts, and visual systems with production-ready specifications.
