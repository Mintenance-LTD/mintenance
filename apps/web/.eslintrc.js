module.exports = {
  ...
  rules: {
    ...
    // Enforce correct casing for Button and Card imports (prevents Linux deployment issues)
        ...
        patterns: [
          {
            ...
            message: 'Use PascalCase paths: @/components/ui/Button and @/components/ui/Card (required for Linux deployments)',
          },
        ],
      },
    ],
