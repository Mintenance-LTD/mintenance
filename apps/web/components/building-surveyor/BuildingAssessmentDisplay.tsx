  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-xs font-[460] text-gray-500 text-center px-4 pt-2">
        This AI-generated assessment is for informational purposes only and does not
        constitute a professional building survey, structural engineering report, or
        legal/insurance advice. Always consult a qualified professional.
      </div>
    </div>
  );
}
...
/**
 * AI Disclaimer Banner - Legal requirement (Issues 3 & 27)
 * Makes clear this is automated analysis, not a professional opinion.
 */
export function AIDisclaimerBanner() {
  return (
    <div className="rounded-lg border border-amber-300 bg-amber-50 p-4">
      <div className="flex items-start gap-3">
        <Icon name="warning" size={20} color="#D97706" className="mt-0.5 shrink-0" />
        <div className="space-y-1">
          ...
          <p className="text-xs font-[460] text-amber-800 leading-relaxed">
            This assessment was generated by artificial intelligence and is provided for
            informational purposes only. It does <strong>not</strong> constitute a professional
            building survey, structural engineering report, or any form of professional advice.
            It should not be relied upon for insurance claims, legal proceedings, or safety
            decisions. Always consult a qualified RICS-accredited surveyor or structural
            engineer before making decisions about property repairs or safety matters.
          </p>
        </div>
      </div>
    </div>
