    ...
    >
      ...
      <div className='relative z-10 flex-1 flex flex-col'>
        ...
        <div className='flex items-center justify-between mb-4'>
          ...
          {Icon && (
            <div
              className={`w-10 h-10 rounded-xl flex items-center justify-center ${colors.iconBg} ${colors.iconText} group-hover:scale-110 transition-transform duration-300`}
            >
          ...
          <div className='mt-auto pt-4 border-t border-gray-100'>
            ...
            <div className='h-12 -mx-2 mb-2'>
              <ResponsiveContainer width='100%' height='100%'>
                <DynamicAreaChart data={sparklineData}>
                  <defs>
                    <linearGradient
                      id={`gradient-${title}-${color}`}
                      x1='0'
                      y1='0'
                      x2='0'
                      y2='1'
