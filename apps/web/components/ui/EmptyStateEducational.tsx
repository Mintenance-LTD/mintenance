...
const getEmptyStateConfig = (
  ...
  const configs: Record<EmptyStateType, EmptyStateConfig> = {
    ...
    connections: {
      ...
      // Audit P1 (2026-04-23): "Discover Contractors" used to link to
      // /contractor/social, a dead-end placeholder. Repointed at
      // /contractor/discover (the live job-discovery surface), which is
      // a more truthful match for the CTA label anyway.
      actions: [
        {
...
export const EmptyStateEducational: React.FC<EmptyStateEducationalProps> = ({
  ...
  return (
    ...
    >
      {/* Icon */}
      <div className='mb-6 p-4 bg-teal-50 rounded-full'>{config.icon}</div>
