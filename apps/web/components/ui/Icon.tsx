...
const ICONS: Record<string, JSX.Element> = {
    ...
    userCheck: (
      <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z M20 8l-3 3m0 0l-2-2m2 2v-3" />
    ),
    xCircle: (
    ...
    // Alias for navigation icon (maps to mapPin)
    navigation: (
      <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
    ),
