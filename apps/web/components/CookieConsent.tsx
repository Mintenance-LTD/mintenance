            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div className="flex-1">
                ...
                <p id="cookie-consent-description" className="text-sm text-gray-600">
                  ...
                  <Link href="/cookies" className="text-[#10B981] hover:underline font-medium">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                <button
                  ...
                  className="px-6 py-2 border-2 border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition-colors whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:ring-offset-2"
                >
                  Manage Preferences
                </button>
                <button
                  onClick={rejectNonEssential}
                  className="px-6 py-2 border-2 border-[#10B981] text-[#10B981] rounded-lg font-medium hover:bg-[#10B981] hover:text-white transition-colors whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:ring-offset-2"
                >
                ...
                <button
                  ...
                  onClick={acceptAll}
                  className="px-6 py-2 bg-[#10B981] text-white rounded-lg font-medium hover:bg-[#059669] transition-colors whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:ring-offset-2"
                >
                  Accept All
                </button>
              </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  className="text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:ring-offset-2 rounded-lg p-1"
              ...
              <div className="space-y-4 mb-6 max-h-[50vh] overflow-y-auto">
                ...
                <fieldset className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <legend className="font-semibold text-[#0F172A] mb-1">
                        Essential Cookies
                      </legend>
                    ...
                    <div className="ml-4 flex-shrink-0">
                      <div className="flex items-center h-6">
                        ...
                        />
                        <label htmlFor="cookie-essential" className="ml-2 text-sm font-medium text-gray-500">Always Active</label>
                      </div>
                    </div>
                  </div>
                </fieldset>
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="ml-4 flex-shrink-0">
                      <div className="flex items-center h-6">
                        ...
                        />
                        <label htmlFor="cookie-analytics" className="sr-only">Enable analytics cookies</label>
                      </div>
                    </div>
                  </div>
                </fieldset>
                ...
                <fieldset className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">
                        These cookies enable enhanced functionality and personalisation, such as remembering your language preferences,
                        region, or display settings. They may be set by us or by third-party providers.
                      </p>
                      <p className="text-xs text-gray-500 mt-2">
                    ...
                    <div className="ml-4 flex-shrink-0">
                      <div className="flex items-center h-6">
                        <input
                          ...
                          onChange={(e: React.ChangeEvent<HTMLInputElement>) => setPreferences({ ...preferences, functional: e.target.checked })}
                          aria-label="Functional cookies"
                          className="w-5 h-5 text-[#10B981] bg-gray-100 border-gray-300 rounded focus:ring-[#10B981] cursor-pointer"
                        />
                        <label htmlFor="cookie-functional" className="sr-only">Enable functional cookies</label>
                      </div>
                    </div>
                  </div>
                </fieldset>
                    ...
                    <div className="ml-4 flex-shrink-0">
                      <div className="flex items-center h-6">
                        <input
                          ...
                          className="w-5 h-5 text-[#10B981] bg-gray-100 border-gray-300 rounded focus:ring-[#10B981] cursor-pointer"
                        />
                        <label htmlFor="cookie-marketing" className="sr-only">Enable marketing cookies</label>
                      </div>
                    </div>
                  </div>
                </fieldset>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-end">
                <button
                  onClick={rejectNonEssential}
                  className="px-6 py-2 border-2 border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:ring-offset-2"
                >
                ...
                <button
                  ...
                  className="px-6 py-2 bg-[#10B981] text-white rounded-lg font-medium hover:bg-[#059669] transition-colors focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:ring-offset-2"
                >
                  Save Preferences
                </button>
              </div>
