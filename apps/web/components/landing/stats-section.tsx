      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
            UK homeowners lose billions to cowboy builders every year.
            Mintenance was built to fix that.
          </p>
        </div>
        ...
        {stats && (stats.activeContractors > 0 || stats.completedJobs > 0) && (
          <div className='mt-16 pt-16 border-t border-gray-200'>
            <p className='text-center text-sm font-semibold text-teal-700 uppercase tracking-wider mb-8'>
              Mintenance by the numbers
            </p>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
              <AnimatedStat
                end={11}
              ...
              <AnimatedStat
                ...
                label='Pipe Leak Detection Accuracy'
                suffix='%'
                subtext='Measured on 194-sample validation set'
              />
              {stats.activeContractors > 0 && (
                <AnimatedStat
                  ...
                  suffix='+'
                  subtext={
                    stats.activeContractorsGrowth
                      ? `+${stats.activeContractorsGrowth}% this month`
                      : 'And growing'
                  }
                />
              )}
              {stats.completedJobs > 0 && (
                <AnimatedStat
                  ...
                  suffix='+'
                  subtext={
                    stats.completedJobsGrowth
                      ? `+${stats.completedJobsGrowth}% this month`
                      : 'And counting'
                  }
                />
              )}
