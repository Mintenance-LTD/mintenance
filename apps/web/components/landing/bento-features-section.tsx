      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
            Upload a photo of any property problem. Get an instant assessment
            with repair costs &mdash; no account needed.
          </p>
        </motion.div>
            ...
            <div className='relative h-full p-8 flex flex-col justify-between min-h-[240px] hover:scale-[1.02] transition-transform duration-300'>
              <div>
                ...
                <p className='text-gray-600 leading-relaxed mb-4'>
                  Browse verified contractors matched to your job. Compare bids,
                  reviews, and portfolios.
                </p>
              </div>
              <Link
                href='/discover'
                className='inline-flex items-center text-pink-600 font-semibold hover:text-pink-700 group/link'
              >
                Find contractors
                <svg
          ...
          >
            ...
            <div className='relative h-full p-8 flex flex-col justify-between min-h-[240px] hover:scale-[1.02] transition-transform duration-300'>
              <div>
                ...
                <p className='text-gray-600 leading-relaxed mb-4'>
                  Your money stays with us until you approve the work. You are
                  always in control.
                </p>
              </div>
              <Link
                href='/payments'
                className='inline-flex items-center text-amber-600 font-semibold hover:text-amber-700 group/link'
              >
                Learn more
                <svg
                  className='w-4 h-4 ml-2 transition-transform group-hover/link:translate-x-1'
