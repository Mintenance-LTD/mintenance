  ...
  const analyzeImage = async (file: File) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (errorDetails) {
          if (
            ...
            errorDetails =
              'The API key is present but OpenAI rejected it. Please verify the key is correct and has not expired.';
          } else if (
            ...
            errorDetails =
              'To enable AI assessment, add your OpenAI API key to the .env.local file in the project root. Get your key from https://platform.openai.com/api-keys';
          }
        }
      ...
      setResult({
        ...
        recommendation:
          data.recommendation || 'Contact a specialist for detailed assessment',
    ...
    <div className='py-20 bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#334155] text-white relative overflow-hidden'>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        ...
        <div className='text-center mb-12'>
          ...
          <h2 className='text-5xl font-bold mb-4'>Instant Damage Assessment</h2>
          <p className='text-xl text-slate-200 max-w-3xl mx-auto'>
            Upload a photo and get expert AI analysis in seconds. Powered by
            Mint AI.
          </p>
        </div>
              ...
              {!isAnalyzing && !showResults && !uploadedImage && (
                <>
                  ...
                  <p className='text-white/80 mb-4 text-center px-4'>
                    Upload damage photo for instant analysis
                  </p>
                  <Button
              ...
              {isAnalyzing && (
                <div className='text-center'>
                  ...
                  <p className='text-slate-200 text-sm mt-2'>
                    Building Surveyor AI is examining the image
                  </p>
                </div>
              )}
              ...
              <>
                ...
                <div className='space-y-4'>
                  ...
                  <FeatureItem
                    ...
                    title='AI-Powered'
                    description='Powered by Mint AI'
                  />
                  <FeatureItem
              ...
              <div className='bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 animate-in slide-in-from-right duration-500'>
                ...
                <div className='space-y-4'>
                  ...
                  <ResultItem
                    ...
                    badge={getSeverityBadge(result.severity)}
                  />
                  <ResultItem
                    label='Confidence'
                  ...
                  <ResultItem
                    ...
                    badge={getUrgencyBadge(result.urgency)}
                  />
                </div>
                ...
                {result.safetyHazards && result.safetyHazards.length > 0 && (
                  <div className='mt-4 p-4 bg-red-500/20 rounded-xl border border-red-400/30'>
                    <p className='text-sm font-semibold text-red-200 mb-2 flex items-center gap-1'>
                      <AlertCircle className='w-4 h-4' /> Safety Hazards
                      Detected:
                    </p>
                ...
                <div className='mt-6 p-4 bg-[#10B981]/20 rounded-xl border border-[#10B981]/30'>
                  ...
                  <Button
                    onClick={() =>
                      (window.location.href = `/register?role=homeowner&project=${encodeURIComponent(result.damageType)}`)
                    }
                ...
                <p className='mt-4 text-xs text-slate-400 leading-relaxed'>
                  This AI-generated assessment is for informational purposes
                  only and does not constitute a professional building survey or
