...
export function GDPRSettings() {
  ...
  const handleExportData = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `mintenance-data-export-${new Date().toISOString().split('T')[0]}.json`;
      ...
      <Dialog open={showExportDialog} onOpenChange={setShowExportDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              We'll prepare a complete export of all your personal data. This may take a few moments.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent>
          ...
          <Alert variant="destructive" style={{ marginTop: theme.spacing[4] }}>
            ...
            <AlertDescription>
              This will permanently delete your account, all properties, jobs, messages, and associated data. 
