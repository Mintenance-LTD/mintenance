...
export function AuthBrandSide({ title, description, role }: AuthBrandSideProps) {
  const features = role === 'contractor' ? [
  ...
  ] : [
    {
      ...
      description: 'Vetted contractors ready to help',
    },
    {
      icon: Shield,
  ...
  return (
    <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-slate-800 to-teal-900 text-white p-12 flex-col justify-between relative overflow-hidden">
      {/* Background Pattern */}
      ...
      {/* Gradient Orbs */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-teal-500/10 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-teal-500/20 rounded-full blur-[120px] translate-y-1/2 -translate-x-1/3" />

      {/* Content */}
      <div className="relative z-10">
        <Link href="/" className="inline-flex items-center space-x-3 mb-16 group">
          <div className="transform transition-transform group-hover:scale-110 duration-300 bg-white p-2.5 rounded-xl shadow-sm border border-white/20">
        ...
        <div className="mt-8 pt-6 border-t border-white/20">
          <div className="flex items-center justify-between text-sm">
            <div>
              ...
              <p className="text-white/70">Projects completed every day</p>
            </div>
      ...
      {/* Footer */}
      <div className="relative z-10 mt-8 text-sm text-white/60">
