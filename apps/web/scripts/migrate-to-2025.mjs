 ...
 *
 * Usage:
 *   node apps/web/scripts/migrate-to-2025.mjs [--dry-run] [--step archive|rename|components]
 *
 * Options:
...
function findPage2025Files(dir, files = []) {
...
function getArchivePath(originalPath) {
 ...
 */
function archiveLegacyPages(dryRun) {
 ...
 */
function renamePage2025Files(dryRun) {
 ...
 */
function archiveLegacyComponents(dryRun) {
  log('\n=== Step 3: Archive Legacy Components ===\n', 'info');
  const results = [];
