 ...
 */
function extractSAM3Confidence(sam3Evidence: unknown): number {
 ...
 */
function extractGPT4Confidence(gpt4Assessment: unknown): number {
  if (!gpt4Assessment) {
    return 0;
  }
 ...
 */
function extractSceneGraphScore(sceneGraphFeatures: unknown): number {
