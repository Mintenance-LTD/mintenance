          ...
          <div className="max-w-3xl">
            ...
            <div className="grid grid-cols-3 gap-6 mt-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-teal-400">{totalCount}+</div>
  ...
  return (
    ...
    >
      ...
      <div className="relative h-56 overflow-hidden">
        ...
        {/* Verified Badge */}
        {contractor.verified && (
          <div className="absolute top-4 left-4 px-3 py-1.5 bg-white/95 backdrop-blur-sm rounded-full flex items-center gap-1.5 shadow-lg">
            <Shield className="w-4 h-4 text-teal-600" />
        ...
        {contractor.rating >= 4.8 && (
          <div className="absolute top-4 right-4 px-3 py-1.5 bg-gradient-to-r from-amber-400 to-amber-500 rounded-full flex items-center gap-1.5 shadow-lg">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="px-5 py-2.5 bg-gradient-to-r from-teal-600 to-emerald-600 text-white rounded-xl font-semibold hover:from-teal-700 hover:to-emerald-700 transition-all duration-200 shadow-md hover:shadow-lg">
            View Profile
          </button>
        </div>
      </div>
...
function ContractorListCard({ contractor }: { contractor: ContractorData }) {
  ...
  return (
    <div
      className="bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 group cursor-pointer"
      onClick={() => window.location.href = `/contractors/${contractor.id}`}
    >
      <div className="flex gap-6">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
            {contractor.hourly_rate ? (
              <div>
                <span className="text-3xl font-bold text-slate-900">£{contractor.hourly_rate}</span>
                <span className="text-gray-600 ml-2">/hour</span>
              </div>
            ) : (
              <span className="text-gray-600 font-medium">Contact for pricing</span>
            )}
            <button className="px-6 py-3 bg-gradient-to-r from-teal-600 to-emerald-600 text-white rounded-xl font-semibold hover:from-teal-700 hover:to-emerald-700 transition-all duration-200 shadow-md hover:shadow-lg">
              View Profile
            </button>
          </div>
        </div>
