  ...
  return (
    <div className='bg-white rounded-2xl border border-gray-200 p-12 text-center'>
      ...
      <p className='text-gray-600 mb-8 max-w-md mx-auto'>
        We couldn&apos;t find any contractors matching your criteria. Try
  ...
  const trustFeatures = [
    {
      ...
      description:
        'Every contractor undergoes thorough background verification before joining our platform.',
      color: 'text-teal-600',
      bgColor: 'bg-teal-50',
    },
    {
      ...
      description:
        'All professionals carry valid insurance and licensing for your peace of mind.',
      color: 'text-blue-600',
      bgColor: 'bg-blue-50',
    },
    {
      ...
      title: 'Review System',
      description:
        'Read authentic reviews from real homeowners to make informed decisions.',
    ...
    },
    {
      ...
      description:
        'Secure escrow system ensures your payment is protected until work is complete.',
      ...
      <div className='max-w-7xl mx-auto px-6'>
        ...
        <div className='text-center mb-16'>
          ...
          <h2 className='text-4xl font-bold text-slate-900 mb-4'>
            Why hire through Mintenance?
          </h2>
          <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
            We take the guesswork out of hiring. Every contractor on our
            platform is vetted, verified, and trusted by thousands of
            homeowners.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
          {trustFeatures.map((feature, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-14 h-14 ${feature.bgColor} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
        ...
        {/* Stats Bar */}
        {/* Platform safeguards strip — previously displayed four fabricated
            stats (100% Verified Professionals, £2M+ Protected Payments, 24/7
            Customer Support, 98% Satisfaction Rate). Replaced with four
            verifiable platform behaviours. */}
    ...
    <section className='relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-20'>
      ...
      <div className='absolute inset-0 opacity-10'>
        <div
          ...
          style={{
            backgroundImage:
              'radial-gradient(circle at 20% 50%, rgba(20, 184, 166, 0.3) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(16, 185, 129, 0.3) 0%, transparent 50%)',
          }}
        />
      </div>
      ...
      <div className='relative max-w-4xl mx-auto px-6 text-center'>
        ...
        <p className='text-xl text-gray-300 mb-10 max-w-2xl mx-auto'>
          Post your job and let local contractors come to you. Get competitive
          quotes, compare portfolios, and hire with confidence.
        </p>
