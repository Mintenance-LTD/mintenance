...
// 2026-05-23 audit: the live anonymous_reports.urgency CHECK only
// allows low | medium | high | emergency. The previous 'urgent' value
// here was rejected by the DB, so every tenant who picked the most
// severe option saw a generic "Failed to submit report." Aligned the
// stored value to 'emergency'; the human-readable label stays bold
// so the form still reads naturally.
const URGENCY_OPTIONS = [
  ...
  { value: 'high', label: 'High', description: 'Needs attention this week' },
  {
    value: 'emergency',
    label: 'Emergency',
    description: 'Immediate risk — needs same-day attention',
  },
] as const;
    ...
    return (
      <div className='text-center py-16'>
        ...
        <p className='text-gray-500'>
          This reporting link is invalid or has been deactivated. Please contact
          your property manager for a new link.
        </p>
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      <p className='text-sm text-gray-500 mb-6'>
        Fill in the details below. Your report will be sent directly to the
        property manager.
      </p>
