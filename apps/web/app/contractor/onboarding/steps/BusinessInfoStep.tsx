...
export function BusinessInfoStep({ data, onNext, saving }: Props) {
  ...
  function validate(): boolean {
    ...
    else if (!/^[\d\s+\-()]{7,20}$/.test(form.phoneNumber.trim())) next.phoneNumber = 'Enter a valid phone number.';
  ...
  return (
    <form onSubmit={handleSubmit} noValidate>
      ...
      <p className="text-sm text-gray-500 mb-6">Tell homeowners about your business.</p>
