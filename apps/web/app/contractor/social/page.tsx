...
function ContractorSocialContent() {
  ...
  return (
    <ContractorPageWrapper>
      ...
      >
        <h1 className="text-3xl font-bold mb-2 text-gray-900">Contractor Network</h1>
        <p className="text-gray-600 text-base">Connect, share your work, and get inspired</p>
      </MotionDiv>
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 lg:col-span-3">
              <MotionDiv
                ...
                animate="animate"
              >
                <h2 className="text-base font-semibold text-gray-900 mb-4">Feed Filters</h2>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-base font-bold text-gray-900">324</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-600">Following</span>
                      <span className="text-base font-bold text-gray-900">142</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-600">Posts</span>
                      <span className="text-base font-bold text-gray-900">67</span>
                    </div>
                  </div>
                </div>
              </MotionDiv>
