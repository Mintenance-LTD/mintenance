...
import { Invoice, formatCurrency, formatDate, getRelativeDate, getInitials } from './types';
import { StatusBadge } from './StatusBadge';
import { ActionMenu } from './ActionMenu';

// Invoice Card Component - Calendar styling
export const InvoiceCard = ({ invoice, onSend, onMarkPaid, onRemind, onDelete, onDownloadPDF }: {
  invoice: Invoice;
