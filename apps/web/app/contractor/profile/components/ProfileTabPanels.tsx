    ...
    <>
      <div className='space-y-6'>
        ...
        {activeTab === 'overview' && (
          <>
            ...
            <MotionDiv
              ...
              className='bg-white rounded-xl border border-gray-200 p-6'
            >
              <h2 className='t-h3 text-gray-900 mb-6'>Performance Metrics</h2>
            ...
            {contractor.admin_verified && (
              <MotionDiv
                ...
                className='bg-white rounded-xl border border-gray-200 p-6'
              >
                <h2 className='t-h3 text-gray-900 mb-4'>
        ...
        {activeTab === 'company' && (
          ...
          >
            <div className='mb-6'>
              <h2 className='t-h3 text-gray-900 mb-1'>Company Information</h2>
                ...
                <div className='space-y-3'>
                  ...
                  <div className='flex items-center gap-3 px-4 py-3 bg-gray-50 rounded-lg'>
                    ...
                    <span className='text-gray-900'>
                      {contractor.city || 'City not set'},{' '}
                      {contractor.country || 'Country not set'}
                    </span>
                  </div>
                </div>
              </div>
                    ...
                    <div>
                      ...
                      <span className='ml-2 text-gray-900 font-medium'>
                        {contractor.created_at
                          ? new Date(contractor.created_at).getFullYear()
                          : 'N/A'}
                      </span>
                    </div>
                  </div>
              ...
              {!isEditMode && (
                <div className='mt-6 p-4 bg-teal-50 border border-teal-200 rounded-lg'>
                  <p className='text-sm text-teal-800'>
                    Click &quot;Edit profile&quot; above to update your company
                    information.
                  </p>
                </div>
              )}
        ...
        {activeTab === 'services' && (
          ...
          >
            <div className='flex items-center justify-between mb-6'>
              <div>
                <h2 className='t-h3 text-gray-900'>Skills & Expertise</h2>
            ...
            {skills.length === 0 ? (
              ...
              <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3'>
                {currentSkills.map((skill, index) => (
                  ...
                  >
                    {skill.skill_icon && (
                      <span className='text-lg'>{skill.skill_icon}</span>
                    )}
        ...
        {activeTab === 'portfolio' && (
          ...
          >
            <div className='flex items-center justify-between mb-6'>
              <div>
                <h2 className='t-h3 text-gray-900'>Portfolio</h2>
                <p className='text-sm text-gray-600 mt-1'>
            ...
            {posts.length === 0 ? (
              <div className='text-center py-16 border-2 border-dashed border-gray-200 rounded-xl'>
                ...
                <p className='text-gray-500 mb-6'>
                  Start building your portfolio to attract more clients
                </p>
                {isEditMode && (
                  <button
                    onClick={onAddPortfolioClick}
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                {posts.map((post, index) => (
                  ...
                  >
                    ...
                    <div className='p-5'>
                      <h3 className='font-semibold text-slate-900 text-base mb-2 line-clamp-1'>
                        {post.title}
                      </h3>
                      {post.help_category && (
        ...
        {activeTab === 'reviews' && (
          ...
          >
            <div className='mb-6'>
              <h2 className='t-h3 text-gray-900'>
        ...
        {activeTab === 'certifications' && (
          ...
          >
            <div className='flex items-center justify-between mb-6'>
              ...
              {isEditMode && (
                <button className='px-4 py-2 bg-teal-600 text-white rounded-lg font-medium hover:bg-teal-700 flex items-center gap-2 transition-colors'>
                  <Plus className='w-4 h-4' />
                  Add certification
                </button>
              )}
