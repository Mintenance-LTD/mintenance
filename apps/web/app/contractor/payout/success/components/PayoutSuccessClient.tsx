...
export function PayoutSuccessClient(props: PayoutSuccessClientProps) {
  ...
  // 2026-05-13 polish pass: editorial card shell + canonical heading
  // when the cookie is set. Transient Stripe Connect return URL — most
  // contractors land here once during onboarding, so the polish is
  // best-effort.
        ...
        {hasPaymentSetup ? (
          <>
            ...
            <p className='text-gray-600 mb-6'>
              Your payout account has been successfully set up. You can now
          ...
          <>
            ...
            <p className='text-gray-600 mb-6'>
              Your payment setup is being processed. This may take a few
              moments. If you've completed all steps, please wait a moment and
              refresh this page.
            </p>
            <div className='space-y-4'>
              <Button
            ...
            <Alert className='mt-6 border-blue-200 bg-blue-50'>
              <AlertDescription className='text-blue-700'>
                If setup doesn't complete within a few minutes, please contact
                support or try setting up again from the payouts page.
              </AlertDescription>
            </Alert>
          </>
        )}
