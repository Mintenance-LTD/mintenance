        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{
              ...
              {!job.show_budget_to_contractors && job.budget_min && job.budget_max ? (
                <span>
                ...
                <span style={{ color: theme.colors.textSecondary, fontSize: theme.typography.fontSize.base }}>
                  Negotiable
                </span>
              )}
            </div>
            ...
            {job.require_itemized_bids && (
              <div style={{
                ...
                <Icon name="list" size={12} color={theme.colors.textSecondary} />
