    ...
    <ContractorPageWrapper>
      ...
      >
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold mb-1 text-gray-900">Learning Resources</h1>
            <p className="text-gray-600 text-base">Guides, tips, and best practices to grow your business</p>
          </div>
        </div>
        ...
        <div className="relative max-w-2xl">
          <input
            ...
            className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all"
          />
          <svg
      ...
      <div className="w-full space-y-6">
          ...
          {selectedCategory === 'All' && searchQuery === '' && (
            ...
            >
              ...
              <MotionA
                ...
                className="block bg-white border-2 border-teal-600 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all group"
                variants={cardHover}
                whileHover="hover"
                whileTap="tap"
              >
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
                  <div className="flex flex-col justify-center">
                    <span className="inline-block px-3 py-1 bg-teal-100 text-teal-700 rounded-lg text-sm font-semibold mb-4 w-fit">
                  ...
                  <div className="hidden lg:flex items-center justify-center">
                    <div className="w-full h-64 bg-teal-50 rounded-xl flex items-center justify-center border border-teal-200">
          ...
          <div className="mb-4">
            <h2 className="text-xl font-bold text-gray-900">
              ...
              <span className="text-gray-500 text-base ml-2">({filteredArticles.length})</span>
            </h2>
          </div>
