    ...
    >
      ...
      >
        ...
        <MetricCard
          ...
          value={
            <AnimatedCounter
              value={financialData.avgJobValue}
              formatType='currency'
              currency='GBP'
              prefix='£'
              decimals={2}
          ...
          trend={
            financialData.avgJobValueChange !== 0
              ? {
                  direction:
                    financialData.avgJobValueChange >= 0 ? 'up' : 'down',
        ...
        <MetricCard
          ...
          trend={
            financialData.profitMarginChange !== 0
              ? {
                  direction:
                    financialData.profitMarginChange >= 0 ? 'up' : 'down',
            ...
            >
              {financialData.transactions.length > 0 ? (
                financialData.transactions.map((transaction) => (
                  <div
                    key={transaction.id}
                    className='flex justify-between items-center p-3 bg-white border border-gray-200 rounded-lg transition-all duration-200 hover:bg-gray-50 hover:shadow-sm'
                  >
