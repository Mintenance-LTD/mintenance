...
export default function ContractorSubscriptionPage2025() {
  ...
  return (
    <ContractorPageWrapper>
      ...
      >
        <div className="inline-block w-16 h-16 bg-teal-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
          <svg className="w-9 h-9 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
          </svg>
        </div>
        <h1 className="text-4xl font-bold mb-2 text-gray-900">Subscription Plans</h1>
        <p className="text-gray-600 text-lg mb-6">Free forever - upgrade anytime for more bids and features</p>

        {/* Billing Toggle */}
        <div className="inline-flex items-center gap-3 bg-gray-100 rounded-2xl p-2">
          <button
