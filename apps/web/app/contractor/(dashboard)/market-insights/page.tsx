...
import { DashboardContentWrapper } from '@/app/contractor/(dashboard)/dashboard-enhanced/components/DashboardContentWrapper';
...
export const metadata: Metadata = {
  ...
  description:
    'Pricing trends, demand forecasting, and market analysis for contractors',
};
...
export default async function MarketInsightsPage() {
  ...
  return (
    <OnboardingWrapper userType='contractor'>
