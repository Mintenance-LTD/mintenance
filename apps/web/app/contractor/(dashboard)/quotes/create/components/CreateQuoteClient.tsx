...
export function CreateQuoteClient() {
  ...
  const clientDetailsComplete = Boolean(
  ...
  const reviewComplete =
    basicDetailsComplete && clientDetailsComplete && lineItemsComplete;
  ...
  const progressValue = Math.round(
    (completedSteps / REQUIRED_STEPS.length) * 100
  );
      ...
      setFeedback({
        ...
        message:
          error instanceof Error
            ? error.message
            : 'Something went wrong while saving your quote.',
      });
    } finally {
      ...
      sidebar={
        <>
          <Card.Dashboard
            ...
            subtitle='Complete each step to send a polished proposal.'
          >
            <ProgressBar
              value={progressValue}
              tone={progressValue === 100 ? 'success' : 'primary'}
            />
            <div
              style={{
          ...
          <Card.Dashboard
            title='Need help?'
            subtitle='Jump back to your pipeline to review existing quotes.'
          >
            <Button
              variant='secondary'
              fullWidth
    ...
    >
      ...
      >
        <Card.Dashboard
          ...
          subtitle='Introduce what this quote covers.'
        >
          <div
            style={{
              display: 'flex',
        ...
        <Card.Dashboard
          ...
          subtitle='Let us know who this quote is for.'
        >
          ...
          >
            ...
            >
              <Input
                ...
                onChange={(e) =>
                  setValidDays(Math.max(1, Number(e.target.value) || 30))
                }
                min='1'
                max='365'
              />
