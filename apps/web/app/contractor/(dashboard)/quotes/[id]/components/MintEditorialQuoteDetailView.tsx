  ...
  return (
    ...
    >
      ...
      <div className='between' style={{ alignItems: 'flex-start', gap: 24 }}>
        ...
        <div className='row no-print' style={{ gap: 8, flexShrink: 0 }}>
          <button
            type='button'
      ...
      >
        ...
        <div className='col' style={{ gap: 16 }}>
          ...
          <section className='card' style={{ padding: 24 }}>
            ...
            <h2 className='t-h3' style={{ margin: 0, marginBottom: 8 }}>
              {quote.title}
            </h2>
            {quote.description ? (
              <p
          ...
          <section className='card' style={{ padding: 0, overflow: 'hidden' }}>
            ...
            {hasItems ? (
              ...
              <div style={{ padding: 32, textAlign: 'center' }}>
                ...
                <p
                  className='t-body'
                  style={{ margin: 0, color: 'var(--me-ink-3)' }}
                >
          ...
          {quote.notes || quote.terms ? (
            <div
              style={{
                display: 'grid',
                gridTemplateColumns:
                  quote.notes && quote.terms ? '1fr 1fr' : '1fr',
                gap: 16,
              }}
            >
              {quote.notes ? (
