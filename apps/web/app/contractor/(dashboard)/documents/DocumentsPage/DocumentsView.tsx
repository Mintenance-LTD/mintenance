              ...
              >
                <div className='flex items-start justify-between mb-3'>
                  <button
                    ...
                    className='p-3 bg-white rounded-lg border border-gray-200 hover:border-emerald-400 hover:shadow-sm transition-all'
                  >
                ...
                <button
                  onClick={() => onView(doc)}
                  className='text-left w-full font-medium text-gray-900 mb-2 line-clamp-2 hover:text-emerald-700 hover:underline cursor-pointer'
                >
                  {doc.name}
                </button>
                ...
                <div className='flex gap-2'>
                  <button
                    onClick={() => onView(doc)}
                    className='flex-1 px-3 py-2 bg-white border border-emerald-600 text-emerald-700 rounded-lg hover:bg-emerald-50 transition-colors text-sm flex items-center justify-center gap-1'
            ...
            {filteredDocuments.map((doc) => (
              ...
              >
                ...
                <div className='flex-1 min-w-0'>
                  <button
                    onClick={() => onView(doc)}
                    className='text-left font-medium text-gray-900 truncate hover:text-emerald-700 hover:underline cursor-pointer block w-full'
                  >
                    {doc.name}
                  </button>
