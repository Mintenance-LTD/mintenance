          ...
          upcomingAppointments.map((appointment) => (
            ...
            >
              <div className='flex items-start justify-between mb-3'>
                <h4 className='font-semibold text-slate-900 text-sm leading-tight flex-1 pr-2'>
                  {appointment.title}
                </h4>
                <div
                  className={`flex items-center gap-1.5 px-2.5 py-1 rounded-lg border text-xs font-semibold ${getTypeColor(appointment.type)}`}
                >
