        ...
        {loading ? (
          <div className='p-6 space-y-3'>
            {[1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                className='flex items-center gap-4 p-6 bg-white rounded-2xl animate-pulse'
              >
                ...
                >
                  ...
                  <div className='flex-1 min-w-0 text-left'>
                    ...
                    <div className='flex items-center gap-3'>
                      <p
                        className={`text-sm truncate flex-1 ${conv.unreadCount > 0 ? 'text-slate-900 font-semibold' : 'text-slate-600'}`}
                      >
