      ...
      <div className='space-y-5'>
        ...
        <div id='field-tin'>
          ...
          <div className='relative'>
            <input
              ...
              value={
                tinFocused
                  ? formData.tin
                  : maskTin(formData.tin, formData.tinType)
              }
              ...
              placeholder={
                formData.tinType === 'ssn' ? 'XXX-XX-XXXX' : 'XX-XXXXXXX'
              }
              maxLength={11}
              aria-required='true'
          ...
          <p id='tin-hint' className='mt-1 text-xs text-gray-500'>
            Your TIN is encrypted and only the last 4 digits are displayed after
            entry.
          </p>
          {fieldError('tin')}
        </div>
