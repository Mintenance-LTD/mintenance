...
export function ContractorDataPrivacy({
  contractorId,
}: ContractorDataPrivacyProps) {
  ...
  const handlePreferenceChange = async (
    ...
    if (key === 'dataProcessing' && !value) {
      setMessage({
        type: 'error',
        text: 'Data processing is required to use our service.',
      });
      return;
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ flex: 1 }}>
            ...
            >
              Share anonymized data with trusted partners for service
              improvement
            </div>
          </div>
          <Switch
      ...
      >
        ...
        >
          As a UK/EU resident, you have the right to access, export, and delete
          your personal data.
        </p>
      ...
      <Dialog open={showExportDialog} onOpenChange={setShowExportDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              We'll prepare a complete export of all your personal data
              including profile, jobs, bids, reviews, and payment information.
