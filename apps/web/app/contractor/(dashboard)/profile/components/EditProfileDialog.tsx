...
export function EditProfileDialog(props: EditProfileDialogProps) {
  ...
  const [imagePreview, setImagePreview] = useState<string | null>(
    contractor?.profile_image_url || null
  );
  ...
  const [activeTab, setActiveTab] = useState<
    'basic' | 'location' | 'business' | 'skills'
  >('basic');
                    ...
                    <div className='flex items-center justify-between p-5 bg-gray-50 rounded-lg border'>
                      <div>
                        ...
                        <p className='text-sm text-gray-600 m-0'>
                          Show your profile to homeowners looking for
                          contractors
                        </p>
                      </div>
                ...
                <TabsContent value='business' className='mt-0'>
                  <div className='space-y-6'>
                    ...
                    <div>
                      ...
                      />
                      <p className='text-xs text-gray-500 mt-2'>
                        Your license number will be verified by our admin team.
                        Once verified, you'll receive a verification badge.
                      </p>
                    </div>
                  </div>
                </TabsContent>
                  ...
                  <div className='space-y-6'>
                    <div>
                      ...
                      <p className='text-sm text-gray-600 mt-2 mb-4'>
                        Select skills that match your expertise. Jobs requiring
                        these skills will appear in your "Jobs Near You" feed.
                      </p>
                      ...
                      {selectedSkills.length > 0 && (
                        <div className='flex flex-wrap gap-2 mb-4'>
                          {selectedSkills.map((skill) => (
                            ...
                            >
                              {React.createElement(
                                getSkillIconComponent(getSkillIcon(skill)),
                                {
                                  className: 'h-4 w-4',
