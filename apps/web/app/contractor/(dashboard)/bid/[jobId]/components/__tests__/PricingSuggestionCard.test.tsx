...
vi.mock('@/components/ui/MotionDiv', () => ({
  MotionDiv: ({ children, className, ...props }: any) => (
...
describe('PricingSuggestionCard', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('displays AI reasoning', () => {
      ...
      expect(
        screen.getByText('This price is competitive based on market analysis.')
      ).toBeInTheDocument();
    });
  ...
  describe('Cost Breakdown Visualization', () => {
    ...
    it('renders stacked bar chart', () => {
      ...
      const stackedBar = screen.getByRole('img', {
        name: /cost breakdown visualization/i,
      });
  ...
  describe('Optional Fields', () => {
    ...
    it('displays sample size when available', () => {
      ...
      expect(
        screen.getByText('Based on 15 similar accepted bids')
      ).toBeInTheDocument();
    });
  ...
  describe('Accessibility', () => {
    ...
    it('has proper button labels', () => {
      ...
      expect(
        screen.getByRole('button', { name: /use £1000.00/i })
      ).toBeInTheDocument();
      ...
      expect(
        screen.getByRole('button', { name: 'Dismiss pricing suggestion' })
      ).toBeInTheDocument();
    });
  });
});
