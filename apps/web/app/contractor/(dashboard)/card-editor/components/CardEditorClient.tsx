...
export function CardEditorClient({
  ...
  const [hourlyRate, setHourlyRate] = useState(
    initialProfile.hourly_rate?.toString() || ''
  );
  const [yearsExperience, setYearsExperience] = useState(
    initialProfile.years_experience?.toString() || ''
  );
  const [availability, setAvailability] = useState(
    initialProfile.is_available ? 'available' : 'busy'
  );
  ...
  // Mint Editorial the page header swaps to canonical .t-h1 + .t-body
  // and the form / preview panel shells use .card. Form internals
  // (Input/Textarea/Button) are shared UI components that already
  // pick up theme colours via the .me-legacy-fit boundary.
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setFeedback({
        tone: 'success',
        message: 'Discovery card updated successfully.',
      });
      ...
      <header>
        {isMintEditorial ? (
          <div className='col' style={{ gap: 4 }}>
            <h1 className='t-h1'>Discovery card editor</h1>
            <p className='t-body'>
              Create your professional business card that appears in contractor
              discovery searches.
            </p>
          </div>
        ) : (
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {bio ||
                'Your professional bio will appear here. Describe your expertise and what sets you apart from other contractors.'}
            </p>
          ...
          >
            ...
            >
              ...
              >
                This card appears in search results when homeowners browse
