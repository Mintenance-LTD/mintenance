...
export default function TimeTrackingPage() {
  ...
  const handleExportCSV = () => {
    ...
    const header =
      'Date,Job,Task,Start,End,Duration (h),Rate (\u00A3/h),Earnings (\u00A3),Billable,Status\n';
    const rows = entries
      .map((e) => {
  ...
  const stats = useMemo(() => {
    ...
    const invoicedEarnings = entries
      ...
      {isMintEditorial ? (
        ...
        >
          <div className='col' style={{ gap: 4 }}>
            <h1 className='t-h1'>Time tracking</h1>
            <p className='t-body'>
              Log billable hours against jobs and export at month-end for
              invoicing. Tag entries with a hourly rate to see your effective
              earnings per task.
            </p>
          </div>
            ...
            <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
              <div>
                ...
                <p className='text-gray-600 mt-1'>
                  Track your time and maximise billable hours
                </p>
              </div>
      ...
      <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        ...
        >
          ...
          >
            ...
            <p className='text-2xl font-bold text-gray-900'>
              {'\u00A3'}
              {stats.totalEarnings.toLocaleString('en-GB', {
          ...
          >
            ...
            <p className='text-2xl font-bold text-gray-900'>
              {'\u00A3'}
              {stats.invoicedEarnings.toLocaleString('en-GB', {
                minimumFractionDigits: 0,
              })}
            </p>
          </MotionDiv>
          ...
          >
            ...
            <p className='text-2xl font-bold text-gray-900'>
              {'\u00A3'}
              {stats.pendingEarnings.toLocaleString('en-GB', {
                minimumFractionDigits: 0,
              })}
            </p>
          </MotionDiv>
                    ...
                    {entry.isBillable && (
                      <div className='text-right'>
                        ...
                        <p className='text-lg font-bold text-gray-900'>
                          {'\u00A3'}
                          {((entry.duration / 60) * entry.hourlyRate).toFixed(
                            2
                          )}
                        </p>
                      </div>
