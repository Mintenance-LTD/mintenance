...
interface Job {
  ...
  created_at: string;
  view_count?: number;
  ai_assessment?: React.ComponentProps<
    typeof JobCard2025
  >['job']['ai_assessment'];
}
      ...
      >
        {allJobsCount === 0 ? (
          <EmptyState
            ...
            description='Get matched with local contractors in your area. Create a detailed job listing and typically receive bids within 24–48 hours.'
            ...
            nextSteps={[
              {
                ...
                description:
                  'Upload a photo and get AI-powered cost estimates, severity analysis, and contractor recommendations.',
                href: '/try-mint-ai',
              },
              {
                title: 'Explore job templates',
                description:
                  'Use pre-built templates for common maintenance tasks like plumbing, electrical work, or painting.',
                href: '/jobs/create',
              },
              {
                title: 'Learn how bidding works',
                description:
                  'Understand our transparent bidding process and how to choose the right contractor for your job.',
                href: '/how-it-works',
              },
            ]}
            supportLink={{
              label: 'Need help getting started? Contact support',
