...
export function BidSwipeView(props: BidSwipeViewProps) {
  ...
  const [undoStack, setUndoStack] = useState<
    Array<{ bid: Bid; direction: 'left' | 'right' }>
  >([]);
        ...
        >
          <div className='w-full max-w-md bg-white rounded-2xl border-2 border-gray-200 shadow-xl p-6 select-none'>
            ...
            <div className='text-center mb-4'>
              <Link
                href={`/contractors/${currentBid.contractor.id}?returnTo=job&jobId=${jobId}&bidId=${currentBid.id}&bidAmount=${currentBid.bid_amount}`}
              >
              ...
              <div className='flex items-center justify-center gap-4 mt-2 text-sm text-gray-500'>
                ...
                {currentBid.contractor.completed_jobs !== undefined && (
                  <span>
                    {currentBid.contractor.completed_jobs} jobs completed
                  </span>
                )}
              </div>
            </div>
            ...
            {currentBid.contractor.portfolioImages &&
              currentBid.contractor.portfolioImages.length > 0 && (
                <div className='mb-6'>
                  <div className='text-xs text-gray-500 font-semibold mb-2'>
                    RECENT WORK
                  </div>
