...
export default function FinancialsError({
  ...
  useEffect(() => {
    logger.error('FinancialsError', 'Financials page loading error', {
      error: error.message,
      stack: error.stack,
      digest: error.digest,
    ...
    if (typeof window !== 'undefined' && window.Sentry) {
      window.Sentry.captureException(error, {
        tags: { page: 'financials', errorBoundary: true },
        level: 'error',
      });
    }
  }, [error]);
      ...
      <div className='max-w-md w-full space-y-8'>
        <div className='text-center'>
          ...
          <h2 className='mt-6 text-3xl font-bold text-gray-900'>
            Couldn&rsquo;t load financials
          </h2>

          <p className='mt-2 text-sm text-gray-600'>
            Your payment, subscription, and invoice records are safe — we just
            couldn&rsquo;t fetch them right now.
          </p>
          ...
          <div className='mt-4 p-4 bg-blue-50 rounded-lg text-left'>
            ...
            <ul className='list-disc list-inside text-xs text-blue-700 space-y-1'>
              ...
              <li>Stripe or our payments service is briefly unavailable</li>
        ...
        {process.env.NODE_ENV === 'development' && (
          <details className='mt-4 p-4 bg-gray-100 rounded-lg'>
            ...
            <div className='mt-2 space-y-2'>
              ...
              <p className='text-xs font-medium text-gray-600 mt-2'>Stack:</p>
