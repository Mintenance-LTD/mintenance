          ...
          <div className='prose prose-lg max-w-none'>
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-700 leading-relaxed mb-4'>
                Welcome to Mintenance. These Terms of Service ("Terms") govern
                your use of the Mintenance platform, including our website and
                mobile application. By accessing or using Mintenance, you agree
            ...
            <section className='mb-8 bg-gray-50 p-6 rounded-lg'>
              ...
              <p className='text-gray-700 leading-relaxed'>
                ...
                <br />
                Registered Office: Suite 2 J2 Business Park, Bridge Hall Lane,
                Bury, England, BL9 7NY
                <br />
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-700 leading-relaxed mb-4'>
                Mintenance is a marketplace platform that connects homeowners
                with verified tradespeople for home maintenance, repairs, and
                improvement projects. We provide:
              </p>
              <ul className='list-disc pl-6 mb-4 text-gray-700 space-y-2'>
                ...
                <li>
                  Verification and rating systems to ensure quality and trust
                </li>
              </ul>
              <p className='text-gray-700 leading-relaxed font-medium'>
                Important: Mintenance is a platform provider only. We do not
                provide home services ourselves and are not party to contracts
            ...
            <section className='mb-8'>
              ...
              <ul className='list-disc pl-6 mb-4 text-gray-700 space-y-2'>
                <li>
                  <strong>Homeowner Account:</strong> Post jobs, review bids,
                  hire contractors, make payments
                </li>
                <li>
              ...
              <p className='text-gray-700 leading-relaxed'>
                ...
                include identity checks, qualification verification, and
                insurance validation. We reserve the right to request additional
            ...
            <section className='mb-8 bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-400'>
              ...
              <ul className='list-disc pl-6 mb-4 text-gray-700 space-y-2'>
                <li>
                  Mintenance does not guarantee the quality of work or behaviour
                  of users
                </li>
                <li>
                ...
                <li>
                  You are responsible for ensuring contracts comply with
                  applicable laws
                </li>
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-700 leading-relaxed mb-4'>
                While we encourage users to resolve disputes amicably, we
                provide a comprehensive dispute resolution process:
              </p>
              <ul className='list-disc pl-6 mb-4 text-gray-700 space-y-2'>
                <li>
                ...
                <li>
                  ...
                  within 1-3 days. Resolution times vary by priority: Low (14
                  days), Medium (7 days), High (3 days), Critical (24 hours)
                </li>
                <li>
                  <strong>Mediation (Optional):</strong> Either party can
                  request mediation. We schedule a session with an assigned
                  mediator to help reach a resolution
                </li>
                <li>
                  <strong>Resolution:</strong> We make a final decision based on
                  evidence and platform policies. Decisions on fund release (if
                  in escrow) are binding
                </li>
                <li>
                  <strong>Appeal Process:</strong> If you disagree with the
                  resolution, you may request a review within 7 days with
                  additional evidence
                </li>
              </ul>
              <p className='text-gray-700 leading-relaxed mb-4'>
              ...
              <h3 className='text-xl font-semibold text-gray-900 mb-3'>
                9.2 Legal Disputes with Mintenance
              </h3>
              <p className='text-gray-700 leading-relaxed'>
                These Terms are governed by English law. Disputes will be
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-700 leading-relaxed mb-4'>
                ...
                us a worldwide, non-exclusive, royalty-free licence to use,
            ...
            <section className='mb-8'>
              ...
              <ul className='list-disc pl-6 mb-4 text-gray-700 space-y-2'>
                <li>
                  Mintenance is provided "as is" without warranties of any kind
                </li>
                <li>
                ...
                <li>
                  Our liability is limited to fees paid by you in the last 12
                  months
                </li>
                <li>
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-700 leading-relaxed mb-4'>
                ...
                Outstanding obligations (payments, jobs in progress) must be
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-700 leading-relaxed'>
                ...
                of significant changes by email or through the platform. Your
                continued use after changes constitutes acceptance. If you do
                not agree to the updated Terms, you must stop using Mintenance.
              </p>
            </section>
            ...
            <section className='mb-8'>
              ...
              <ul className='list-disc pl-6 mb-4 text-gray-700 space-y-2'>
                ...
                <li>
                  ...
                  invalid, the remainder continues in effect
                </li>
                <li>
      ...
      <footer className='bg-slate-900 text-white py-8 mt-16'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-sm'>
          ...
          <p className='mt-2 text-gray-400'>
            Company No. 16542104 | Registered in England and Wales
          </p>
        </div>
      </footer>
    </div>
