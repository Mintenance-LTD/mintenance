    ...
    <LegalPageLayout title='Terms of Service' lastUpdated={formatDate()}>
      <section className='mb-8'>
        ...
        <p className='text-gray-700 leading-relaxed mb-4'>
          ...
          govern your use of the Mintenance platform, including our website and
          mobile application. By accessing or using Mintenance, you agree to be
      ...
      <section className='mb-8'>
        ...
        <p className='text-gray-700 leading-relaxed'>
          Contractors must complete our verification process, which may include
          identity checks, qualification verification, and insurance validation.
      ...
      <section className='mb-8'>
        ...
        <p className='text-gray-700 leading-relaxed'>
          ...
          completion. Funds are released when both parties confirm satisfactory
          completion or after the dispute resolution period.
        </p>
      </section>
      ...
      <section className='mb-8'>
        ...
        <ul className='list-disc pl-6 mb-4 text-gray-700 space-y-2'>
          ...
          <li>
            <strong>Review Period:</strong> Our team reviews your dispute within
            1-3 days. Resolution times vary by priority: Low (14 days), Medium
            (7 days), High (3 days), Critical (24 hours)
          </li>
          <li>
      ...
      <section className='mb-8'>
        ...
        <p className='text-gray-700 leading-relaxed mb-4'>
          ...
          functionality, is owned by Mintenance Ltd and protected by copyright,
      ...
      <section className='mb-8'>
        ...
        <p className='text-gray-700 leading-relaxed'>
          You agree to indemnify and hold harmless Mintenance Ltd, its officers,
      ...
      <section className='mb-8 bg-blue-50 p-6 rounded-lg'>
        ...
        <p className='text-gray-700 leading-relaxed'>
          ...
          Mintenance, you acknowledge that you have read, understood, and agree
