...
import { MintEditorialSupport } from './MintEditorialSupport';
...
export default function SupportPage() {
  ...
  // component so the hook order stays stable (rules-of-hooks).
      ...
      <div className='flex items-center justify-between mb-6'>
        <div>
          ...
          <p className='text-gray-500 mt-1'>
            Get dedicated help from our support team
          </p>
        </div>
        <button
      ...
      {loading ? (
        ...
        <div className='text-center py-16 bg-white rounded-xl border border-gray-200'>
          ...
          <p className='text-gray-500'>
            Create a ticket to get priority help from our team.
          </p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                <div className='flex items-start justify-between'>
                  ...
                  <span
                    className={`inline-flex items-center gap-1 text-xs font-medium px-2 py-1 rounded-full ${style.className}`}
                  >
                    {style.icon}
                    {style.label}
                  </span>
