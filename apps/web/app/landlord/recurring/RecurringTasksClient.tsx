      ...
      <div className='flex items-center justify-between mb-8'>
        <div>
          ...
          <p className='mt-1 text-gray-500'>
            Schedule maintenance tasks on a regular cycle.
          </p>
        </div>
        <button
          type='button'
        ...
        <div className='bg-amber-50 border border-amber-200 rounded-xl p-4 mb-4 flex items-start gap-3'>
          ...
          <div>
            <p className='font-medium text-amber-800'>
              {upcoming.length} task{upcoming.length > 1 ? 's' : ''} due within
              30 days
            </p>
          </div>
        </div>
      ...
      {schedules.length === 0 ? (
        <div className='text-center py-16 bg-white rounded-xl border border-gray-200'>
          ...
          <p className='text-gray-500'>
            Set up recurring maintenance to stay on top of compliance.
          </p>
        </div>
      ) : (
              ...
              >
                <div className='flex items-center justify-between'>
                  ...
                  <div className='text-right'>
                    <p
                      className={`text-sm font-medium ${isOverdue ? 'text-red-600' : isDueSoon ? 'text-amber-600' : 'text-gray-600'}`}
                    >
                      {isOverdue
