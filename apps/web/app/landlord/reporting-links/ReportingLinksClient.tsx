...
export function ReportingLinksClient({
  ...
  const getPropertyName = (propertyId: string) =>
    properties.find((p) => p.id === propertyId)?.property_name ||
    'Unknown Property';
    ...
    <div className='max-w-4xl mx-auto px-4 sm:px-6 py-8'>
      <div className='mb-8'>
        ...
        <p className='mt-1 text-gray-500'>
          Create shareable links for tenants to report maintenance issues
          anonymously.
        </p>
      </div>
      ...
      {tokens.length === 0 ? (
        <div className='text-center py-16 bg-white rounded-xl border border-gray-200'>
          ...
          <p className='text-gray-500'>
            Create a link above and share it with your tenants.
          </p>
        </div>
      ) : (
                ...
                <div className='min-w-0 flex-1'>
                  ...
                  <div className='flex items-center gap-4 mt-2 text-xs text-gray-500'>
                    ...
                    {token.last_report_at && (
                      <span>
                        Last report{' '}
                        {new Date(token.last_report_at).toLocaleDateString(
                          'en-GB'
                        )}
                      </span>
                    )}
