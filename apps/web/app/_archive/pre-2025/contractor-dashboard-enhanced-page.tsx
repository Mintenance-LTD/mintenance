                ...
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                  ...
                  <div className="xl:col-span-5 flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="text-center p-6 rounded-xl bg-emerald-50 hover:bg-emerald-100 transition-all duration-200 border border-emerald-100">
                        <p className="text-4xl font-[640] text-emerald-600 mb-2">
