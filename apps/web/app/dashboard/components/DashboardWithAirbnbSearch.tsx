...
export function DashboardWithAirbnbSearch({
  data,
}: DashboardWithAirbnbSearchProps) {
  const {
    homeowner,
    ...
    <div className='space-y-6 pb-12'>
      ...
      <section className='bg-gradient-to-b from-white to-gray-50 px-4 sm:px-6 lg:px-8 py-8'>
        <div className='max-w-6xl mx-auto'>
          ...
          {/* Portfolio Mode — only shown as upsell when user doesn't have access and has 2+ properties */}
          {!loadingPortfolioAccess &&
            portfolioAccess &&
            !portfolioAccess.allowed &&
            properties.length >= 2 && (
              <div className='mt-6 rounded-2xl border p-4 bg-amber-50 border-amber-200'>
                <div className='flex items-start justify-between gap-4'>
                  <div className='flex items-start gap-3'>
                    <div className='mt-0.5 flex h-10 w-10 items-center justify-center rounded-lg bg-amber-100'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-gray-700'>
                        {portfolioAccess.message ||
                          'Manage multiple properties with landlord and agent tools.'}
                      </p>
                    </div>
                  </div>
                  <Link
                    href={portfolioAccess.upgradeUrl || '/subscription'}
                    className='inline-flex items-center rounded-lg px-3 py-2 text-sm font-medium bg-amber-600 text-white hover:bg-amber-700'
                  >
                    Unlock
                  </Link>
                </div>
      ...
      <BidsReceivedSection pendingBids={pendingBids} />
          ...
          <div className='lg:col-span-2 space-y-6'>
            ...
            <div>
              ...
              <p className='text-gray-600 text-sm mb-6'>
                Track progress on your home improvement projects
              </p>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  {activeJobs.slice(0, 4).map((job) => {
                    ...
                    const imageSrc = job.photoUrl
                      ? job.photoUrl
                      : job.category
                        ? categoryImages[job.category.toLowerCase()] ||
                        ...
                        <div className='relative h-48 bg-gradient-to-br from-gray-100 to-gray-200'>
                          <Image
                            ...
                            unoptimized={
                              ...
                              !imageSrc.includes('unsplash.com')
                            }
                          />
                          {job.bidsCount > 0 && (
