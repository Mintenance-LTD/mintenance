...
export function FindContractorsClient({
  contractors,
      ...
      >
        <div className='max-w-[1600px] mx-auto px-8 py-16 text-center'>
          ...
          <p className='text-teal-100 text-xl mb-8'>
            Connect with verified professionals for your home improvement
            projects
          </p>
                ...
                <div className='flex flex-wrap gap-2 mb-4'>
                  {contractor.specialties
                    ...
                    .map((specialty, index) => (
                      <span
                        key={index}
                        className='px-3 py-1 bg-teal-100 text-teal-700 rounded-lg text-xs font-semibold'
                      >
                        {specialty}
                      </span>
                    ))}
          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
            ...
            <div>
              ...
              <ul className='space-y-2 text-sm text-gray-400'>
                ...
                <li>
                  <Link href='/find-contractors' className='hover:text-white'>
                    Find Contractors
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className='space-y-2 text-sm text-gray-400'>
                ...
                {/* Audit P1 (2026-04-23): "Resources" link removed —
                    /contractor/resources is a dead-end placeholder. */}
                <li>
