...
export const metadata: Metadata = {
  ...
  description: 'Get verified as a trusted contractor on Mintenance. Increase your visibility, win more jobs, and build trust with homeowners through our verification process.',
  keywords: 'contractor verification, verified badge, trusted contractors, background check, business verification, contractor credentials',
  openGraph: {
    title: 'Contractor Verification - Get Verified | Mintenance',
    description: 'Get verified as a trusted contractor. Increase visibility, win more jobs, and build trust with homeowners.',
    type: 'website',
    images: [
      {
...
const WHY_WE_VERIFY = [
  {
    ...
    description: 'Homeowners can see that a contractor has provided a real business name, address, and licence so they can hire with confidence.',
    icon: Shield,
  },
  {
    title: 'Fair and transparent',
    description: 'We check company details and business address, validate licence format, and only award the verified badge after review.',
    icon: CheckCircle,
  },
  {
...
const HOW_IT_WORKS_STEPS = [
  ...
  },
  {
    ...
    description: 'You enter your trade or business licence number. We validate the format; our team may use it as part of review.',
    icon: Award,
    required: true,
  },
  {
  ...
  },
  {
    id: 'review',
    title: 'Our review',
    description: 'Our team reviews your details. We may run automated checks (e.g. address, licence format). Approved contractors get the verified badge.',
    icon: CheckCircle,
    required: false,
  },
];
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center mb-12">
              <div className="inline-flex p-4 rounded-2xl bg-teal-50 mb-6">
                <Shield className="w-12 h-12 text-teal-600" aria-hidden="true" />
              </div>
            ...
            <section className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 mb-10">
              ...
              <p className="text-gray-600 mb-6">
                Verification helps homeowners know they're hiring a real business. We check company name, business address, and licence information so that when you see the verified badge, it means we've reviewed those details. We do it to keep the platform safe, fair, and trustworthy for everyone.
              </p>
            ...
            <section className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 mb-10">
              ...
              <p className="text-gray-600 mb-6">
                Contractors submit their business details in the verification centre. We validate the information (including address geocoding and licence format) and our team reviews it. Approved contractors receive the verified badge.
              </p>
              <ul className="space-y-6">
                {HOW_IT_WORKS_STEPS.map((step) => {
                  ...
                  return (
                    ...
                    >
                      <Icon className="w-6 h-6 text-teal-600 flex-shrink-0 mt-0.5" aria-hidden="true" />
                      <div>
            ...
            <section className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 text-center">
              <FileCheck className="w-12 h-12 text-teal-600 mx-auto mb-4" aria-hidden="true" />
