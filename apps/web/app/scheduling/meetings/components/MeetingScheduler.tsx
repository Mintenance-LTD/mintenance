...
export function MeetingScheduler(props: MeetingSchedulerProps) {
  ...
  const [meetingType, setMeetingType] = useState<
    'site_visit' | 'consultation' | 'work_session'
  >('site_visit');
    ...
    >
      ...
      >
        ...
        <CardHeader>
          ...
          <CardDescription>
            Coordinate a site visit or consultation
          </CardDescription>
        </CardHeader>
          ...
          >
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: theme.spacing[2] }}>
                ...
                <Button
                  variant={
                    meetingType === 'consultation' ? 'primary' : 'outline'
                  }
                  size='sm'
                ...
                <Button
                  variant={
                    meetingType === 'work_session' ? 'primary' : 'outline'
                  }
                  size='sm'
