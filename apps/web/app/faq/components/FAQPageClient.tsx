...
export default function FAQPageClient() {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer: 'Our AI analyses your job requirements (type, budget, location, urgency) and matches them with contractors who have: relevant expertise, high ratings, availability, geographic proximity, and appropriate certifications. This ensures you get quality bids from suitable professionals.',
      category: 'jobs',
    },
    {
      id: '13',
