 ...
 *
 * Audit P1 (2026-04-23): the live-call surface is unbuilt. Sidebar entries
 * (homeowner + contractor) removed; in-thread "Start Now / Voice / Video
 * Call" buttons in the message client no longer push here — they show a
 * "coming soon" toast instead. Page kept so direct URLs and the legacy
 * VideoCallScheduler "view details" prompt have a friendly landing.
 *
 * Note: `app/video-calls/components/VideoCallScheduler.tsx` is real and
 * embedded as a modal inside `messages/[jobId]/page.tsx` — that flow
 * still creates rows in `video_calls`. Only the standalone page needs
 * a real surface before the sidebar entry is restored.
 */
      ...
      <div className='w-full flex flex-col items-center justify-center min-h-[60vh] px-4'>
        ...
        <div className='bg-white rounded-2xl border border-gray-200 shadow-sm p-10 max-w-lg w-full text-center'>
          ...
          <p className='text-gray-600 mb-8 leading-relaxed'>
            We are building video call functionality so you can connect
            face-to-face with contractors for consultations, site assessments
            and project discussions. Stay tuned for updates.
          </p>
