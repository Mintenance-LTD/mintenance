    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <div className="mb-10">
            <div className="flex flex-col sm:flex-row justify-between gap-8 mb-8">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <p className="flex items-start gap-2">
                    ...
                    <span>{invoice.contractor.address}</span>
                  </p>
                  ...
                  {invoice.contractor.taxId && (
                    <p className="text-xs mt-2">VAT No: {invoice.contractor.taxId}</p>
                  )}
                </div>
              </div>
              ...
              <div className="sm:text-right">
                <h3 className="text-3xl font-bold text-gray-900 mb-4">INVOICE</h3>
            ...
            <div className="bg-gray-50 rounded-xl p-5 mb-6">
              <h4 className="text-xs font-bold text-gray-700 uppercase tracking-wider mb-3">Bill To</h4>
          ...
          {/* Invoice Items - Using PricingBreakdown */}
          <div className="mb-8">
        ...
        {invoice.amountDue > 0 && (
          <MotionDiv
            ...
            animate="visible"
            variants={fadeIn}
            className="mt-6 bg-teal-50 rounded-xl border border-teal-100 p-6 print:hidden"
          >
