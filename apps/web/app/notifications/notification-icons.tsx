/**
 * Notification icon + color helpers for the inbox page. Extracted from
 * page.tsx to keep it under the 500-line pre-commit limit.
 */
...
const systemInnerPath = 'M15 12a3 3 0 11-6 0 3 3 0 016 0z';

export function getNotificationIcon(type: string): React.ReactElement {
  const key = paths[type] ? type : 'default';
  return (
    <svg
      className='w-5 h-5'
      fill='none'
