...
export function RevenueBreakdownChart({
  ...
  const pieData = [
    {
      name: 'Subscriptions',
      value: revenueMetrics.subscriptionRevenue || 0,
      color: theme.colors.adminPrimary,
    },
    {
      name: 'Transaction Fees',
      value: revenueMetrics.transactionFeeRevenue || 0,
      color: '#4CC38A',
    },
  ];
          ...
          {[
            {
              ...
              color: theme.colors.adminPrimary,
              value: revenueMetrics.subscriptionRevenue || 0,
              count: revenueMetrics.subscriptionCount || 0,
              unit: 'payments',
            },
            {
              ...
              color: '#4CC38A',
              value: revenueMetrics.transactionFeeRevenue || 0,
              count: revenueMetrics.transactionCount || 0,
              unit: 'transactions',
            },
          ].map((item) => (
            <div key={item.label}>
