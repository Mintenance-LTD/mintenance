  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-10'>
      ...
      <AdminCard padding='lg' hover>
        ...
        >
          <div style={kpiIconBox('#D1FAE5')}>
            <Icon name='currencyPound' size={24} color='#4CC38A' />
          </div>
          <h3 style={kpiLabel}>MRR</h3>
        </div>
        <p style={{ ...kpiValue, marginBottom: theme.spacing[1] }}>
      ...
      <AdminCard padding='lg' hover>
        ...
        <p style={subText}>
          {conversionRate.convertedTrials} of {conversionRate.totalTrials}{' '}
          trials
        </p>
      </AdminCard>
