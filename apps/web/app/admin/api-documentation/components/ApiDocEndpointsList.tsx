...
export function ApiDocEndpointsList({
  filteredEndpoints,
  expandedEndpoint,
  copiedCode,
  onToggleExpand,
    ...
    <MotionDiv variants={staggerContainer} className='space-y-4'>
      <div className='bg-amber-50 border border-amber-200 rounded-lg p-3 mb-4 flex items-center gap-2'>
        ...
        <p className='text-sm text-amber-800'>
          These are example API endpoints. Full interactive API documentation is
          coming soon.
        </p>
      </div>
        ...
        >
          ...
          >
            <div className='flex items-center gap-4 flex-1'>
              <span
                className={`px-3 py-1 rounded-lg text-xs font-bold border ${getMethodColor(endpoint.method)}`}
              >
                {endpoint.method}
              </span>
