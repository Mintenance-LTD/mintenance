...
export default function MigrationDashboard() {
  ...
  const migrationProgress =
    (migrationStats.migratedRoutes / migrationStats.totalRoutes) * 100;
  return (
    <div className='min-h-screen bg-gray-50 p-8'>
      <div className='max-w-7xl mx-auto'>
        {/* Header */}
          ...
          <div className='bg-white rounded-lg shadow p-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p
                  className={`text-2xl font-semibold mt-1 ${getErrorRateColor(100 - migrationStats.successRate)}`}
                >
          ...
          <div className='bg-white rounded-lg shadow p-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p
                  className={`text-2xl font-semibold mt-1 ${getErrorRateColor(migrationStats.errorRate)}`}
                >
        ...
        <div className='bg-white rounded-lg shadow overflow-hidden'>
          <div className='px-6 py-4 border-b'>
            <h2 className='text-lg font-semibold'>
              Controller Feature Flags (Last 24 Hours)
            </h2>
          </div>
              ...
              <tbody className='bg-white divide-y divide-gray-200'>
                  ...
                  <tr key={flag.name}>
                      ...
                      <div className='flex items-center'>
                        ...
                        <div className='w-16 bg-gray-200 rounded-full h-2'>
                          <div
                            ...
                            style={{
                              width: `${flag.rollout_percentage || 0}%`,
                            }}
                          />
                        </div>
                      </div>
                    ...
                    <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-500'>
                      <span className='text-green-600'>
                        {flag.users_with_new || 0}
                      </span>
                      {' / '}
                      <span className='text-gray-600'>
                        {flag.users_with_old || 0}
                      </span>
                    </td>
                    <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-500'>
                      <span className='text-green-600'>
                        {flag.new_controller_calls || 0}
                      </span>
                      {' / '}
                      <span className='text-gray-600'>
                        {flag.old_controller_calls || 0}
                      </span>
                    </td>
                    <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-500'>
                      {flag.last_used_at
                ...
                {featureFlags.length === 0 && (
                  <tr>
                    ...
                    >
                      No data available. Feature flags may not be configured in
                      the database.
                    </td>
                  </tr>
                )}
