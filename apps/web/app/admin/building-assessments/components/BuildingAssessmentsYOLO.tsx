...
export function BuildingAssessmentsYOLO({
  correctionStats,
  hasAssessments,
}: BuildingAssessmentsYOLOProps) {
  return (
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          <p style={{ fontSize: '13px', color: '#64748B', margin: 0 }}>
            Help improve the AI model by correcting detections.{' '}
            {correctionStats.approved} approved corrections collected.
          </p>
        </div>
      </div>
        ...
        >
          ...
          >
            <div>
              ...
              <p style={{ fontSize: '13px', color: '#64748B', margin: 0 }}>
                Click &quot;Correct Detections&quot; on any assessment to fix AI
                errors and help train better models.
              </p>
            </div>
