...
export default function AdminDashboardPage2025() {
    ...
    async function fetchDashboardData() {
      try {
        ...
        const response = await fetch(
          `/api/admin/dashboard/metrics?period=${selectedPeriod}`
        );
        if (!response.ok) {
  ...
  const metrics = data
    ? [
        ...
        {
          label: 'Contractors',
          value: data.totalContractors.toLocaleString(),
          icon: <Hammer size={24} />,
        },
        {
          label: 'Total Jobs',
        ...
        >
          <div className='max-w-[1600px] mx-auto px-8 py-12'>
            <div className='flex items-start justify-between gap-8'>
              ...
              {/* Period Selector */}
              <div
                className='flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-xl p-1 border border-white/30'
                role='tablist'
          ...
          >
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
              {[
                ...
                >
                  <div
                    className='text-purple-600 mb-2 flex items-center justify-center'
                    aria-hidden='true'
                  >
                    {action.icon}
                  </div>
