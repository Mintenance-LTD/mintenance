...
interface UserManagementFiltersProps {
  ...
  onVerifiedFilterChange: (
    status: 'all' | 'verified' | 'pending' | 'false'
  ) => void;
        ...
        >
          <button
            ...
            style={{
              ...
              cursor: 'pointer',
              transition: 'all 0.2s',
              backgroundColor: excludeTestUsers
                ? theme.colors.success
                : theme.colors.backgroundSecondary,
              color: excludeTestUsers
                ? theme.colors.white
                : theme.colors.textPrimary,
              display: 'flex',
              alignItems: 'center',
          ...
          >
            <Icon
              ...
              size={16}
              color={
                excludeTestUsers ? theme.colors.white : theme.colors.textPrimary
              }
            />
