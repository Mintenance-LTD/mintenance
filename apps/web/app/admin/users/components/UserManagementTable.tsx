      ...
      >
        ...
        >
          <caption className='sr-only'>
            Platform users with their roles, verification status, and actions
          </caption>
          <thead
            style={{
              position: 'sticky',
                  ...
                  style={{
                    ...
                    backgroundColor: isSelected
                      ...
                      : isEvenRow
                        ...
                        : '#F8FAFC',
                    borderBottom:
                      index < users.length - 1 ? '1px solid #E2E8F0' : 'none',
                  }}
                  onMouseEnter={(e) => {
                    if (!isSelected)
                  ...
                  >
                    ...
                    >
                      <Button
                        variant='ghost'
                        aria-label={
                          'View details for ' + getUserDisplayName(user)
                        }
                      ...
                      >
                        <Button
                          variant='ghost'
                          aria-label={
                            'Full profile for ' + getUserDisplayName(user)
                          }
                          style={{
                            padding: '6px 12px',
                            fontSize: '13px',
