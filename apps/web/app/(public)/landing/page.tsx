...
export const metadata: Metadata = {
  ...
  keywords:
    'contractors, home maintenance, home repair, plumber, electrician, handyman, home improvement, contractor near me, trusted contractors, verified professionals',

  // Open Graph
  openGraph: {
    type: 'website',
    locale: 'en_GB',
    url: 'https://mintenance.com/landing',
    siteName: 'Mintenance',
    title: 'Mintenance - Find Trusted Local Contractors for Home Maintenance',
    description:
      'Connect with verified contractors. Get instant quotes, compare prices, and hire trusted professionals for your home maintenance needs.',
    images: [
      {
  ...
  twitter: {
    ...
    description:
      'Connect with verified contractors for all your home maintenance needs. Get instant quotes and hire trusted professionals.',
    images: ['https://mintenance.com/twitter-card.jpg'],
  },

  // Additional SEO — canonical differs from root page to avoid duplicate content
  alternates: {
    canonical: 'https://mintenance.com/landing',
  },
  robots: {
    index: true,
    follow: true,
      ...
      <div className='min-h-screen bg-white'>
        ...
        <section className='relative h-[600px] md:h-[700px] flex items-center justify-center'>
          ...
          <div className='relative z-10 max-w-4xl mx-auto px-4 text-center'>
            ...
            >
              Connect with verified professionals for your home maintenance
              needs
            </p>
            ...
            {/* Trust Indicators */}
            <div
              className='mt-8 flex items-center justify-center gap-6 text-white/90 text-sm animate-fade-in'
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-12'>
              ...
              <div className='text-center animate-slide-up'>
                ...
                <p className='text-gray-600'>
                  Describe your project and let contractors know what you need
                  done
                </p>
              </div>
          ...
          <div className='max-w-7xl mx-auto px-4'>
            <div className='max-w-4xl mx-auto rounded-2xl border border-teal-100 bg-teal-50/60 p-8'>
              ...
              <p className='text-gray-700 text-center mb-6'>
                Free profile includes unlimited job posts, up to 5 bids per job,
                and up to 3 saved properties. Premium unlocks unlimited
                properties and Portfolio Mode for landlord/agent workflows.
              </p>
                ...
                <div className='space-y-6'>
                  <div className='flex gap-4'>
                    ...
                    <div>
                      ...
                      <p className='text-gray-600'>
                        Every contractor is background-checked and verified
                  ...
                  <div className='flex gap-4'>
                    ...
                    <div>
                      ...
                      <p className='text-gray-600'>
                        Read reviews from real homeowners and see contractor
                        portfolios before hiring
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-4'>
                    ...
                    <div>
                      ...
                      <p className='text-gray-600'>
                        Secure payment system ensures you only pay when the job
