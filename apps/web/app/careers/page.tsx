...
export const metadata: Metadata = {
  ...
  description:
    'Join the Mintenance team and help us revolutionise home maintenance services.',
};
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              We&apos;re building the future of home maintenance. Come help us
              connect homeowners with trusted tradespeople across the UK.
            </p>
          </div>
            ...
            <div className='space-y-6'>
              <div className='border-l-4 border-teal-600 pl-6 py-4'>
                ...
                <p className='text-gray-600 mb-4'>
                  We&apos;re looking for an experienced developer to help build
                  and scale our platform using Next.js, React, and TypeScript.
                </p>
                <Link
              ...
              <div className='border-l-4 border-teal-600 pl-6 py-4'>
                ...
                <p className='text-gray-600 mb-4'>
                  Help us create beautiful, intuitive experiences for homeowners
                  and contractors.
                </p>
                <Link
