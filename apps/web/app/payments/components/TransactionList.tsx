...
function getStatusConfig(status: string) {
  switch (status) {
    ...
    case 'held':
      return {
        label: status === 'held' ? 'Protected' : 'Pending',
        icon: Clock,
        classes: 'bg-amber-50 text-amber-700 border-amber-200',
        dot: 'bg-amber-500',
      };
            ...
            >
              ...
              <div className='hidden md:grid grid-cols-12 gap-4 items-center'>
                ...
                <div className='col-span-1 flex justify-center'>
                  <span
                    className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-semibold border ${statusConfig.classes}`}
                  >
                    <span
              ...
              <div className='md:hidden space-y-3'>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <div className='flex items-center gap-2'>
                    <span
                      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold border ${statusConfig.classes}`}
                    >
                      <span
                        className={`w-1.5 h-1.5 rounded-full ${statusConfig.dot}`}
                      />
