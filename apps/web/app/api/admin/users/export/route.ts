...
export const GET = withApiHandler(
  ...
  async (request) => {
    ...
    let query = serverSupabase
      .from('profiles')
      .select(
        'id, email, first_name, last_name, role, company_name, admin_verified, created_at, updated_at'
      )
      .is('deleted_at', null);
    ...
    // Safety limit: cap export to 10,000 rows to prevent memory exhaustion
