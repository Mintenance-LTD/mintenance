...
import { jobSelectFields, mapRowToJobDetail, updateJobSchema, type JobRow, type Params } from './shared';

export async function handlePatch(request: NextRequest, context: Params) {
  try {
