      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link href="/" className="flex items-center space-x-2">
            <Logo />
            <span className="text-2xl font-bold text-slate-900">Mintenance</span>
          </Link>
        </div>
      </header>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 md:p-12 group relative overflow-hidden">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="text-gray-700 space-y-2">
                <p><strong>Website:</strong> <a href="https://ico.org.uk" className="text-teal-600 hover:text-teal-700 hover:underline focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 rounded" target="_blank" rel="noopener noreferrer">ico.org.uk</a></p>
