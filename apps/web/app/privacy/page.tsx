    ...
    <LegalPageLayout title='Privacy Policy' lastUpdated={formatDate()}>
      <section className='mb-8'>
        ...
        <p className='text-gray-700 leading-relaxed mb-4'>
          ...
          use our platform, whether through our website or mobile application.
        </p>
      ...
      <section className='mb-8'>
        ...
        <ul className='list-disc pl-6 mb-4 text-gray-700 space-y-2'>
          ...
          <li>
            <strong>To ensure safety:</strong> Verify identities, prevent fraud,
      ...
      <section className='mb-8'>
        ...
        <ul className='list-disc pl-6 mb-4 text-gray-700 space-y-2'>
          <li>
            <strong>Other users:</strong> Your profile is visible to facilitate
            connections (you control what is shared)
          </li>
          <li>
      ...
      <section className='mb-8'>
        ...
        <ul className='list-disc pl-6 mb-4 text-gray-700 space-y-2'>
          <li>
            Account data: Until you delete your account, then up to 90 days for
            recovery
          </li>
          <li>
