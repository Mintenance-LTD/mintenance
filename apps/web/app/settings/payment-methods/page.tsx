...
export default function PaymentMethodsPage() {
  ...
  const handleRemoveMethod = async (methodId: string) => {
    ...
    try {
      ...
      const { token: csrfToken } = csrfResponse.ok
  ...
  // here from /settings. The me-legacy-fit override layer maps the
  // Tailwind colors (bg-gray-50, bg-white, etc.) onto the mint
  // palette without needing to retrofit every utility class.
  return (
          ...
          <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
            <DialogContent className='max-w-2xl'>
              <DialogHeader>
                ...
                <DialogDescription>
                  Add a new payment method to your account for quick and easy
                  payments
                </DialogDescription>
              </DialogHeader>
              <div className='mt-4'>
