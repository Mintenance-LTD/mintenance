            ...
            <div className='grid md:grid-cols-2 gap-8 mb-8'>
              <div className='bg-white rounded-xl shadow-sm p-8'>
                ...
                <p className='text-gray-600 mb-6'>
                  Download our logo, brand guidelines, and high-resolution
              ...
              <div className='bg-white rounded-xl shadow-sm p-8'>
                ...
                <p className='text-gray-600 mb-6'>
                  Have a question or want to schedule an interview? Get in touch
                  with our press team.
                </p>
                <Link
              ...
              <div className='space-y-6'>
                <div className='border-b border-gray-200 pb-6'>
                  <h3 className='text-xl font-semibold text-gray-900 mb-2'>
                    Mintenance Launches AI-Powered Job Matching
                  </h3>
                  <p className='text-gray-600 mb-2'>2025</p>
                  <p className='text-gray-600'>
                    Mintenance introduces advanced AI technology to match
                    homeowners with the perfect contractors for their projects.
                  </p>
                </div>
                <div className='border-b border-gray-200 pb-6'>
                  <h3 className='text-xl font-semibold text-gray-900 mb-2'>
                  ...
                  <p className='text-gray-600 mb-2'>2025</p>
                  <p className='text-gray-600'>
                    Mintenance officially launches, connecting homeowners with
                    local contractors across the UK.
                  </p>
                </div>
              </div>
            </div>
