...
export function dynamicImport<P = Record<string, unknown>>(
  importFn: () => Promise<
    { default: ComponentType<P> } | Record<string, unknown>
  >,
...
export const routeBasedImports = {
  ...
  contractor: {
    Dashboard: () =>
      dynamicImport(
        () =>
          import('@/app/contractor/dashboard-enhanced/components/ContractorDashboard2025Client')
      ),
    Discover: () =>
      dynamicImport(
        () =>
          import('@/app/contractor/discover/components/ContractorDiscoverClient')
      ),
    Profile: () =>
      dynamicImport(
        () =>
          import('@/app/contractor/profile/components/ContractorProfileClient2025')
      ),
    Jobs: () => dynamicImport(() => import('@/app/contractor/jobs/page')),
    Bid: () =>
      dynamicImport(
        () =>
          import('@/app/contractor/bid/[jobId]/components/BidSubmissionClient2025')
      ),
  },
  ...
  homeowner: {
    Dashboard: () =>
      dynamicImport(() => import('@/app/dashboard/components/DashboardClient')),
    Jobs: () => dynamicImport(() => import('@/app/jobs/page')),
    CreateJob: () => dynamicImport(() => import('@/app/jobs/create/page')),
    Properties: () =>
      dynamicImport(
        () => import('@/app/properties/components/PropertiesClient2025')
      ),
    Contractors: () =>
      dynamicImport(
        () => import('@/app/contractors/components/ContractorsBrowseClient')
      ),
  },
  ...
  common: {
    Chat: () =>
      dynamicImport(() => import('@/app/messages/page'), { ssr: false }),
    VideoCall: () =>
      dynamicImport(() => import('@/app/video-calls/page'), { ssr: false }),
    Scheduling: () =>
      dynamicImport(
        () => import('@/app/scheduling/components/SchedulingClient2025')
      ),
...
export function reportBundleSize() {
  ...
  if ('performance' in window && 'measure' in performance) {
    try {
      ...
      logger.error('Failed to collect bundle metrics:', {
        error,
        service: 'lib',
      });
    }
