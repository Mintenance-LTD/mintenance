...
export class JobAnalysisService {
   ...
   * Google Cloud Vision removed — text analysis only.
   * Image analysis is handled by GPT-4o in the Building Surveyor pipeline.
   */
  static async analyzeJobWithImages(
    ...
    return this.analyzeJobDescription(title, description, location);
  }
