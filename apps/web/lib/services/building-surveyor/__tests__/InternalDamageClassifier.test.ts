...
describe('InternalDamageClassifier', () => {
  ...
  describe('Prediction', () => {
    ...
    it('should return consistent low confidence for any feature values', async () => {
      ...
      const highPrediction =
        await InternalDamageClassifier.predict(highFeatures);
    ...
    it('should return valid severity values', async () => {
      ...
      expect(['early', 'developing', 'significant', 'dangerous']).toContain(
        prediction.severity
      );
    });
  ...
  describe('Training Data Statistics', () => {
    ...
    it('should have correct severity distribution keys', async () => {
      ...
      expect(stats.severityDistribution).toHaveProperty('developing');
      expect(stats.severityDistribution).toHaveProperty('significant');
      expect(stats.severityDistribution).toHaveProperty('dangerous');
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle features with extreme values', async () => {
      ...
      const prediction =
        await InternalDamageClassifier.predict(extremeFeatures);
    ...
    it('should handle negative feature values', async () => {
      ...
      const prediction =
        await InternalDamageClassifier.predict(negativeFeatures);
  ...
  describe('Damage Type Classification', () => {
    ...
    it('should return same unknown damage type for all features', async () => {
      ...
      const lowPrediction = await InternalDamageClassifier.predict(lowFeatures);
      const mediumPrediction =
        await InternalDamageClassifier.predict(mediumFeatures);
      const highPrediction =
        await InternalDamageClassifier.predict(highFeatures);
