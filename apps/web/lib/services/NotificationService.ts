...
export interface NotificationData {
  ...
  type: 'job_update' | 'bid_received' | 'meeting_scheduled' | 'payment_received' | 'message_received' | 'quote_sent' | 'system' | 'social_interaction';
...
export class NotificationService {
   ...
   * Security fix: API now uses authenticated user, userId param removed
   */
  static async getUnreadCount(userId: string): Promise<number> {
    try {
      // API now uses authenticated user from cookies, no userId param needed
