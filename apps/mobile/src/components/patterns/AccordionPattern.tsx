...
export const Accordion = memo<AccordionProps>(
  ({ children, multiple = false, defaultOpen = [], onValueChange, testID }) => {
...
const AccordionTrigger = memo<AccordionTriggerProps>(
...
const AccordionContent = memo<AccordionContentProps>(
  ({ children, style, testID }) => {
    ...
    return (
      <Animated.View
        style={[styles.accordionContent, { opacity: height }, style]}
        testID={testID}
      >
        {children}
      </Animated.View>
