...
import { SustainabilityScoreWidgetx } from '../../services/SustainabilityScoreWidgetx';
...
describe('SustainabilityScoreWidgetx', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  describe('Initialization', () => {
    it('should initialize service successfully', async () => {
      ...
      expect(SustainabilityScoreWidgetx).toBeDefined();
    });
  });
