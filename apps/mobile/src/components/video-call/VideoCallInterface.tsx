...
const VideoCallInterface: React.FC<VideoCallInterfaceProps> = ({
  ...
  const initializeCall = useCallback(async () => {
    try {
      ...
      performanceMonitor.recordMetric(
        'video_call_initialization',
        Date.now() - performanceStartTime.current
      );
  ...
  const toggleAudio = useCallback(async () => {
    try {
      ...
      logger.info('Audio toggled', { muted: newMutedState });
    } catch (error) {
      ...
      <SafeAreaView style={styles.permissionContainer}>
        <View style={styles.permissionContent}>
          ...
          <Text style={styles.permissionMessage}>
            Please grant camera and microphone permissions to join the video
            call.
          </Text>
            ...
            <View style={styles.localVideo}>
              <View style={styles.localVideoDisabled}>
                <Ionicons
                  ...
                  color={theme.colors.textInverse}
                />
                <Text style={styles.videoPlaceholderSmall}>
                  Camera Unavailable
                </Text>
              </View>
            </View>
