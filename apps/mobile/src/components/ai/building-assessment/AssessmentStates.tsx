...
export const RunAssessmentButton: React.FC<RunButtonProps> = ({ onPress, disabled }) => (
  <TouchableOpacity style={styles.runAssessmentButton} onPress={onPress} disabled={disabled}>
    <Ionicons name='sparkles' size={24} color={theme.colors.textInverse} />
...
const styles = StyleSheet.create({
  runAssessmentButton: { backgroundColor: theme.colors.textPrimary, padding: 20, borderRadius: 12, alignItems: 'center', marginVertical: 8 },
  runAssessmentText: { color: theme.colors.textInverse, fontSize: 16, fontWeight: '600', marginTop: 8 },
  runAssessmentSubtext: { color: theme.colors.textInverse, fontSize: 12, marginTop: 4, opacity: 0.8 },
