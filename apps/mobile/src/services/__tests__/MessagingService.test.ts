...
import * as MessagingServiceModule from '../MessagingService';
...
describe('MessagingService', () => {
  ...
  describe('module exports', () => {
    it('should export MessagingService', () => {
      expect(MessagingServiceModule.MessagingService).toBeDefined();
    });

    it('should have expected structure', () => {
      const service = MessagingServiceModule.MessagingService;
