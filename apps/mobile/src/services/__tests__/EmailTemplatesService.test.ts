import * as EmailTemplatesServiceModule from '../EmailTemplatesService';
...
describe('EmailTemplatesService', () => {
  ...
  describe('module exports', () => {
    it('should export EmailTemplatesService', () => {
      expect(EmailTemplatesServiceModule.EmailTemplatesService).toBeDefined();
    });

    it('should have expected structure', () => {
      const service = EmailTemplatesServiceModule.EmailTemplatesService;
