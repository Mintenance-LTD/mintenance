...
export const SafeInvoiceManagementScreen = withScreenErrorBoundary(
  InvoiceManagementScreen,
  'Invoice Management',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeCreateInvoiceScreen = withScreenErrorBoundary(
  CreateInvoiceScreen,
  'Create Invoice',
  { fallbackRoute: 'InvoiceManagement' }
);
export const SafeInvoiceDetailScreen = withScreenErrorBoundary(
  InvoiceDetailScreen,
  'Invoice Detail',
  { fallbackRoute: 'InvoiceManagement' }
);
export const SafeCRMDashboardScreen = withScreenErrorBoundary(
  CRMDashboardScreen,
  'CRM Dashboard',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeAddClientScreen = withScreenErrorBoundary(
  AddClientScreen,
  'Add Client',
  { fallbackRoute: 'CRMDashboard' }
);
export const SafeClientDetailScreen = withScreenErrorBoundary(
  ClientDetailScreen,
  'Client Detail',
  { fallbackRoute: 'CRMDashboard' }
);
export const SafeFinanceDashboardScreen = withScreenErrorBoundary(
  FinanceDashboardScreen,
  'Finance Dashboard',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeServiceAreasScreen = withScreenErrorBoundary(
  ServiceAreasScreen,
  'Service Areas',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeQuoteBuilderScreen = withScreenErrorBoundary(
  QuoteBuilderScreen,
  'Quote Builder',
  { fallbackRoute: 'ProfileMain' }
);
...
export const SafeQuoteTemplatesScreen = withScreenErrorBoundary(
  QuoteTemplatesScreen,
  'Quote Templates',
  { fallbackRoute: 'QuoteBuilder' }
);
export const SafeContractorCardEditorScreen = withScreenErrorBoundary(
  ContractorCardEditorScreen,
  'Edit Discovery Card',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeContractorVerificationScreen = withScreenErrorBoundary(
  ContractorVerificationScreen,
  'Contractor Verification',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeBusinessProfileScreen = withScreenErrorBoundary(
  BusinessProfileScreen,
  'Business Profile',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeCalendarScreen = withScreenErrorBoundary(
  CalendarScreen,
  'Calendar',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeReviewsScreen = withScreenErrorBoundary(
  ReviewsScreen,
  'Reviews',
  { fallbackRoute: 'ProfileMain' }
);
...
export const SafeCertificationsScreen = withScreenErrorBoundary(
  CertificationsScreen,
  'Certifications',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeTimeTrackingScreen = withScreenErrorBoundary(
  TimeTrackingScreen,
  'Time Tracking',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeAddTimeEntryScreen = withScreenErrorBoundary(
  AddTimeEntryScreen,
  'Add Time Entry',
  { fallbackRoute: 'TimeTracking' }
);
export const SafeAddCertificationScreen = withScreenErrorBoundary(
  AddCertificationScreen,
  'Add Certification',
  { fallbackRoute: 'Certifications' }
);
export const SafeDBSCheckScreen = withScreenErrorBoundary(
  DBSCheckScreen,
  'DBS Check',
  { fallbackRoute: 'Certifications' }
);
export const SafeReportingScreen = withScreenErrorBoundary(
  ReportingScreen,
  'Reporting',
  { fallbackRoute: 'ProfileMain' }
);
export const SafePayoutsScreen = withScreenErrorBoundary(
  PayoutsScreen,
  'Payouts',
  { fallbackRoute: 'ProfileMain' }
);
