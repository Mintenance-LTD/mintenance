...
export const SafeProfileScreen = withScreenErrorBoundary(
  ProfileScreen,
  'Profile',
  { fallbackRoute: 'Main' }
);
export const SafeEditProfileScreen = withScreenErrorBoundary(
  EditProfileScreen,
  'Edit Profile',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeNotificationSettingsScreen = withScreenErrorBoundary(
  NotificationSettingsScreen,
  'Notification Settings',
  { fallbackRoute: 'ProfileMain' }
);
export const SafePaymentMethodsScreen = withScreenErrorBoundary(
  PaymentMethodsScreen,
  'Payment Methods',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeAddPaymentMethodScreen = withScreenErrorBoundary(
...
export const SafeHelpCenterScreen = withScreenErrorBoundary(
  HelpCenterScreen,
  'Help Center',
  { fallbackRoute: 'ProfileMain' }
);
...
export const SafePropertyDetailScreen = withScreenErrorBoundary(
  PropertyDetailScreen,
  'Property Detail',
  { fallbackRoute: 'Properties' }
);
export const SafeEditPropertyScreen = withScreenErrorBoundary(
  EditPropertyScreen,
  'Edit Property',
  { fallbackRoute: 'PropertyDetail' }
);
export const SafePropertyAssessmentScreen = withScreenErrorBoundary(
  PropertyAssessmentScreen as unknown as React.ComponentType<
...
export const SafeVideoProcessingStatusScreen = withScreenErrorBoundary(
  VideoProcessingStatusScreen as unknown as React.ComponentType<
    Record<string, unknown>
  >,
  'Video Processing',
  { fallbackRoute: 'PropertyAssessment' }
...
export const SafeAddPropertyScreen = withScreenErrorBoundary(
  AddPropertyScreen,
  'Add Property',
  { fallbackRoute: 'Properties' }
);
export const SafePaymentHistoryScreen = withScreenErrorBoundary(
...
export const SafeSettingsHubScreen = withScreenErrorBoundary(
  SettingsHubScreen,
  'Settings',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeBookingStatusScreen = withScreenErrorBoundary(
  BookingStatusScreen,
  'Booking Status',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeInsuranceScreen = withScreenErrorBoundary(
  InsuranceScreen,
  'Insurance',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeTeamScreen = withScreenErrorBoundary(TeamScreen, 'Team', {
  fallbackRoute: 'ProfileMain',
});
export const SafeMarketingScreen = withScreenErrorBoundary(
  MarketingScreen,
  'Marketing',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeMarketInsightsScreen = withScreenErrorBoundary(
  MarketInsightsScreen,
  'Market Insights',
  { fallbackRoute: 'ProfileMain' }
);
// SafeSocialScreen: ARCHIVED - social feature removed
export const SafeTrainingScreen = withScreenErrorBoundary(
  TrainingScreen,
  'Training',
  { fallbackRoute: 'ProfileMain' }
);
export const SafeMFASecurityScreen = withScreenErrorBoundary(
  MFASecurityScreen,
  'MFA Security',
  { fallbackRoute: 'SettingsHub' }
);
export const SafeDataExportScreen = withScreenErrorBoundary(
  DataExportScreen,
  'Data Export',
  { fallbackRoute: 'SettingsHub' }
);
export const SafeDeleteAccountScreen = withScreenErrorBoundary(
  DeleteAccountScreen,
  'Delete Account',
  { fallbackRoute: 'SettingsHub' }
);
// SafePortfolioGalleryScreen: ARCHIVED - portfolio feature removed
export const SafeEscrowDashboardScreen = withScreenErrorBoundary(
