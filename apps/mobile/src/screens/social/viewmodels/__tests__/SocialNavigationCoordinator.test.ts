...
import { SocialNavigationCoordinator } from '../..//SocialNavigationCoordinator';
...
const mockRoute = {
  key: 'test-key',
  name: 'SocialNavigationCoordinator',
  params: {},
};
...
describe('SocialNavigationCoordinator', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  afterEach(() => {
