...
import { BookingNavigationCoordinator } from '../BookingNavigationCoordinator';
...
const mockRoute = {
  key: 'test-key',
  name: 'BookingNavigationCoordinator',
  params: {},
};
  ...
  return render(
    React.createElement(
      ...
      React.createElement(
        NavigationContainer,
        null,
        React.createElement(BookingNavigationCoordinator, {
...
describe('BookingNavigationCoordinator', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  afterEach(() => {
