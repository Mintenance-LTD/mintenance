...
import { ContractorProfileViewModel } from '../ContractorProfileViewModel';
...
const mockRoute = {
  key: 'test-key',
  name: 'ContractorProfileViewModel',
  params: {},
};
  ...
  return render(
    React.createElement(
      ...
      React.createElement(
        NavigationContainer,
        null,
        React.createElement(ContractorProfileViewModel, {
...
describe('ContractorProfileViewModel', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  afterEach(() => {
