        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card} activeOpacity={0.7}>
            ...
            <View style={styles.cardFooter}>
              <View style={[styles.categoryTag, { backgroundColor: (CATEGORY_COLORS[item.category] || theme.colors.textSecondary) + '18' }]}>
                <Text style={[styles.categoryText, { color: CATEGORY_COLORS[item.category] || theme.colors.textSecondary }]}>
...
const styles = StyleSheet.create({
  ...
  cardDesc: { fontSize: 13, color: theme.colors.textSecondary, marginTop: 4, lineHeight: 18 },
