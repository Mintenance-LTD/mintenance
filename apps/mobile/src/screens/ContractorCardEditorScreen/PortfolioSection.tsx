...
export const LogoSection: React.FC<LogoSectionProps> = ({ profile, onPickLogo }) => (
  <View style={styles.section}>
    <Text style={styles.sectionTitle}>Company Logo</Text>
    <TouchableOpacity style={styles.logoUpload} onPress={onPickLogo}>
      {profile.companyLogo ? (
...
export const AvailabilitySection: React.FC<AvailabilitySectionProps> = ({ profile, setProfile }) => (
  <View style={styles.section}>
...
export const PortfolioSection: React.FC<PortfolioSectionProps> = ({ profile, onAddPortfolio, onRemoveImage }) => (
  <View style={styles.section}>
...
export const ServiceAreaSection: React.FC<ServiceAreaSectionProps> = ({ profile, setProfile }) => (
  <View style={styles.section}>
