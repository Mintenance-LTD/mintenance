...
import { VideoProcessingStatusScreen } from '../..//VideoProcessingStatusScreen';
...
const mockRoute = {
  key: 'test-key',
  name: 'VideoProcessingStatusScreen',
  params: {},
};
...
describe('VideoProcessingStatusScreen', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  afterEach(() => {
