    ...
    <View style={styles.panel}>
      ...
      {properties && properties.length > 0 ? (
        properties.map((property) => (
          <TouchableOpacity key={property.id} style={[styles.propertyCard, selectedProperty?.id === property.id && styles.propertyCardActive]} onPress={() => onSelect(property)}>
            <View style={styles.propertyIcon}>
              <Ionicons name='home' size={22} color={selectedProperty?.id === property.id ? theme.colors.primary : theme.colors.textSecondary} />
            </View>
        ...
        <View style={styles.emptyState}>
          <Ionicons name='home-outline' size={36} color={theme.colors.primary} />
...
const styles = StyleSheet.create({
  ...
  propertyCard: { flexDirection: 'row', alignItems: 'center', padding: 14, borderRadius: 16, backgroundColor: theme.colors.surface, marginBottom: 10, gap: 12 },
  propertyCardActive: { backgroundColor: theme.colors.backgroundSecondary },
  ...
  addPropertyButton: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 12, paddingHorizontal: 16, paddingVertical: 10, borderRadius: 28, backgroundColor: theme.colors.backgroundSecondary },
