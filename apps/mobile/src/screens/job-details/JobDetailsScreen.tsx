  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        {/* Building Assessment if available */}
        {viewModel.job.photos && viewModel.job.photos.length > 0 && (
          <BuildingAssessmentCard
            images={viewModel.job.photos}
            jobDetails={{
              title: viewModel.job.title,
              description: viewModel.job.description,
              category: viewModel.job.category,
