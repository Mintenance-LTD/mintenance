...
CREATE INDEX idx_data_sync_jobs_integration_id ON data_sync_jobs(user_integration_id);
CREATE INDEX idx_data_sync_jobs_status ON data_sync_jobs(status);
CREATE INDEX idx_data_sync_jobs_scheduled ON data_sync_jobs(scheduled_for);
CREATE INDEX idx_data_sync_jobs_created ON data_sync_jobs(created_at DESC);
CREATE INDEX idx_data_sync_jobs_entity_type ON data_sync_jobs(entity_type);

-- Webhook deliveries indexes
CREATE INDEX idx_webhook_deliveries_integration_id ON webhook_deliveries(user_integration_id);
...
CREATE INDEX idx_api_rate_limits_integration_id ON api_rate_limits(user_integration_id);
CREATE INDEX idx_api_rate_limits_reset ON api_rate_limits(reset_at);
CREATE INDEX idx_api_rate_limits_exceeded ON api_rate_limits(is_exceeded);

-- Integration logs indexes
CREATE INDEX idx_integration_logs_integration_id ON integration_logs(user_integration_id);
...
CREATE INDEX idx_data_mappings_integration_id ON data_mappings(user_integration_id);
...
CREATE INDEX idx_integration_analytics_provider ON integration_analytics(provider_id);
CREATE INDEX idx_integration_analytics_user_integration ON integration_analytics(user_integration_id);
CREATE INDEX idx_integration_analytics_date ON integration_analytics(date_recorded DESC);
CREATE INDEX idx_integration_analytics_user ON integration_analytics(user_id);

-- Integration marketplace indexes
CREATE INDEX idx_integration_marketplace_provider ON integration_marketplace(provider_id);
CREATE INDEX idx_integration_marketplace_featured ON integration_marketplace(is_featured);
CREATE INDEX idx_integration_marketplace_published ON integration_marketplace(is_published);
CREATE INDEX idx_integration_marketplace_rating ON integration_marketplace(rating_average DESC);
