  ...
  const getVariantStyles = (): React.CSSProperties => {
    ...
    switch (variant) {
      ...
      case 'gradient-primary':
        return {
          ...base,
          background: `linear-gradient(135deg, ${webTokens.colors.primary} 0%, ${webTokens.colors.secondary} 100%)`,
          color: webTokens.colors.white,
          boxShadow: isDisabled ? 'none' : webTokens.shadows.md,
        };
      case 'gradient-success':
        return {
          ...base,
          background: `linear-gradient(135deg, ${webTokens.colors.success} 0%, ${webTokens.colors.secondary} 100%)`,
          color: webTokens.colors.white,
          boxShadow: isDisabled ? 'none' : webTokens.shadows.md,
        };
      default:
