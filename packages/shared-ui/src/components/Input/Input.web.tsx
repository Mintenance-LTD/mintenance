  ...
  (props, ref) => {
    ...
    const baseStyles: React.CSSProperties = {
      ...
      backgroundColor: disabled
        ? webTokens.colors.gray100
        : webTokens.colors.white,
    ...
    const propsStyle = (props as Record<string, unknown>).style as
      | React.CSSProperties
      | undefined;
    ...
    const { style: _, ...propsWithoutStyle } = restProps as Record<
      string,
      unknown
    >;
    ...
    const inputStyles: React.CSSProperties = {
      ...
      ...(normalizedBorderColor && !isFocused
    ...
    if (
      'borderWidth' in normalizedStyle &&
      normalizedStyle.borderWidth !== baseStyles.borderWidth
    ) {
    ...
    if (
      'borderStyle' in normalizedStyle &&
      normalizedStyle.borderStyle !== baseStyles.borderStyle
    ) {
    ...
    const hasBorderShorthand = borderShorthandKeys.some(
      (key) => key in inputStyles
    );
            ...
            {required && (
              <span
                style={{
                  ...
                  marginLeft: webTokens.spacing.xs,
                }}
              >
                *
              </span>
          ...
          <input
            ...
            style={{
              ...
              paddingLeft: leftIcon
                ? `${Number(webTokens.spacing.xl) * 2}px`
            ...
            <span
              style={{
                ...
                color: hasError
                  ...
                  : hasSuccess
                    ? webTokens.colors.success
                    : webTokens.colors.textSecondary,
              }}
              aria-hidden='true'
            >
              {rightIcon}
