...
const bluePngBase64 =
  'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAEElEQVR42mJgYGBgZGBgYAAAAAQAAg8LkqQAAAAASUVORK5CYII=';
...
console.log(
  '🎨 You should replace these with proper branded assets before store submission.'
);
console.log('');
