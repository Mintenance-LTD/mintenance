...
class PresenceDetectionBenchmark {
        ...
        const scenarios = [
            {
                ...
                filter: (img: any) => img.category === 'undamaged',
            },
            {
                name: 'All Damaged Images',
                filter: (img: any) => img.category === 'damaged',
            },
            {
                name: 'Mixed (50/50)',
            ...
            },
            {
                ...
                filter: (img: any) => img.category === 'borderline',
            },
        ];
    ...
    private async benchmarkWithPresenceDetection(testImages: any[]): Promise<any> {
    ...
    private async benchmarkWithoutPresenceDetection(testImages: any[]): Promise<any> {
        const startTime = performance.now();
        let falsePositives = 0;
        let falseNegatives = 0;
        let yoloTotalTime = 0;
    ...
    private calculateMonthlySavings(summary: any): any {
        // Assumptions
